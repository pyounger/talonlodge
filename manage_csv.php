...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage CSV content generation  <a href="generate_csv.php?pms_pak_id=<?php echo $_REQUEST['pms_pak_id'];?>" target="_blank">CLICK HERE FOR CSV OUTPUT</a> <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
                    ...
                    <div class="panel-body">
                        <form name="frm" id="frm" method="post" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>" class="form-horizontal" role="form">
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="" >
                                <thead>
                                    <tr>
                                        <th class="visible-xs visible-sm visible-md visible-lg">FName<br/><br/>LName<br/><br/>Group Name</th>
<!--                                        <th class="visible-xs visible-sm visible-md visible-lg">LName</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Group Name</th>-->
                                        <th class="visible-xs visible-sm visible-md visible-lg">Arrival Date</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Addr1<br/><br/>Addr2</th>
<!--                                        <th class="visible-xs visible-sm visible-md visible-lg">Addr2</th>-->
                                        <th class="visible-xs visible-sm visible-md visible-lg">City<br/><br/>State<br/><br/>Zip</th>
<!--                                        <th class="visible-xs visible-sm visible-md visible-lg">State</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Zip</th>-->
                                        <th class="visible-xs visible-sm visible-md visible-lg">Phone</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">E-Mail</th>
                                        ...
                                        <th class="visible-xs visible-sm visible-md visible-lg">Room Assignment</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Boat Assignment</th>
                                        ...
                                        <th class="visible-xs visible-sm visible-md visible-lg">Log</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
...
<!--                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
                                                    <?php echo (($row->arrival_flight_data=='0000-00-00 00:00:00')?'':calendarDateConver2($row->arrival_flight_data));?>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
...
<!--                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
                                                    <?php echo 'City: '.$row->cont_city;?><br/><br/>
                                                    <?php echo 'State: '.$row->cont_state;?><br/><br/>
                                                    <?php echo 'Zip: '.$row->cont_zip;?>
                                                </td>
<!--                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <?php echo $row->cont_state;?>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <?php echo $row->cont_zip;?>
                                                </td>-->
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
                                                    <?php echo $row->cont_phone1;?>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 20px;">
                                        ...
                                        if ($count111 > 0) {
                                            while ($row111 = mysql_fetch_object($rs111)) {
                                                ...
                                                ?>
                                                        ...
                                                        <?php if($counter==1){?>
                                                            <?php echo returnName("room_title", "rooms", "room_id", $row4->room_id);?>
                                                        <?php }?>                                                    
