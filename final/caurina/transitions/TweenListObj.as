class caurina.transitions.TweenListObj
{
    ...
    {
        var _loc2 = new caurina.transitions.TweenListObj(scope, timeStart, timeComplete, useFrames, transition);
    ...
    static function makePropertiesChain(p_obj)
    {
        ...
        if (_loc6)
        {
            ...
            for (var _loc1 = 0; _loc1 < _loc7; ++_loc1)
            {
                if (_loc2[_loc1].base)
                {
                    _loc4 = caurina.transitions.AuxFunctions.concatObjects(caurina.transitions.TweenListObj.makePropertiesChain(_loc2[_loc1].base), _loc2[_loc1]);
                }
                else
                {
                    _loc4 = _loc2[_loc1];
                } // end else if
                _loc5 = caurina.transitions.AuxFunctions.concatObjects(_loc5, _loc4);
            } // end of for
            if (_loc5.base)
            {
                delete _loc5.base;
