...
//	Configuration
//
var fileLoadingImage = "loading.gif";				// Loading image		
var fileBottomNavCloseImage = "closelabel.gif";		// Close image
var fallbackOverlayImage = "overlay.png";			// Fallback overlay used with browsers that have opacity problems
...
Lightbox.prototype = {
	...
	resizeElementContainer: function(elementWidth, elementHeight) {
		...
		if((hDiff == 0) && (wDiff == 0)){
			if (navigator.appVersion.indexOf("MSIE")!=-1){ pause(100); } else { pause(50);} 
		}
