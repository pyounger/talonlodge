...
if (isset($_REQUEST['action'])) {
    if (isset($_REQUEST['btnAdd'])) {
        ...
        mysql_query("INSERT INTO group_contacts (gcont_id, grp_id, Pms_Booking_ID, ContactID, GroupArrivalDate, createdDate) VALUES(" . $gcont_id . ", '" . $_REQUEST['grp_id'] . "', '" . $Pms_Booking_ID . "', " . $ContactID . ", '" . $grp_arrival_date . "', NOW())") or die(mysql_error());
            ...
            <div class="panel panel-cascade">
                ...
                <div class="panel-heading text-primary">
                    <?php //if($_SESSION["UType"]==1){?>
                        <h3 class="panel-title"><i class="fa fa-user"></i> Guest Profile
...
<!--                                        <a href="<?php print("sync/contacts.php?getContacts=1"); ?>"><i class="fa fa-plus"></i> Synchronize Contacts </a> | -->
                                    ...
                                    <?php if($_SESSION['group_id']>0){?>    
                                        <?php if ( ($total_prof != $consumed_prof) && ($_SESSION['UType']!=3) ) { ?>
                                            ...
                                            <a href="<?php print($_SERVER['PHP_SELF'] . "?action=1&invite_guest=1"); ?>" title="Invite Guest"><i class="fa fa-plus"></i> Invite Guest </a>
                                        <?php } ?>
                                    <?php } ?>
                                </div>
                            </span>
