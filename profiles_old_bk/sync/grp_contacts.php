...
if (isset($_REQUEST['getGrpContacts'])) {
	...
	$rs = mysql_query("SELECT c.Mag_ContactID, c.ContactID, g.grp_id, g.Pms_Booking_ID, g.GroupArrivalDate, g.createdDate FROM contacts AS c INNER JOIN groups AS g WHERE g.Contact_ID=c.ContactID AND g.Pms_Booking_ID>".$lastID);
