...
$CPF_CONFIG['MODEL']['OUTLET']['CONFIG']['classes']['App_Model_Package'] = array(
	...
	'props' => array(
		...
		'package_Notes' => array('package_Notes', 'varchar'),

		'package_Terms' => array('package_Terms', 'varchar'),
	...
	'resources' => array(
		...
		'package_Notes' => t('tables.packages.package_Notes'),

		'package_Terms' => t('tables.packages.package_Terms'),
