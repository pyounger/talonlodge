	...
	*/
	...
	var cuselFrame = '<div class="cusel '+chElClass+' '+classDisCusel+'"'+
					...
					'<div class="cusel-scroll-wrap">'+
						'<div class="cusel-scroll-pane" id="cusel-scroll-'+chElId+'">'+spanStr+'</div>'+
					'<div class="cusel-scroll-wrap-b">'+
					'</div>'+
					'<input type="hidden" id="'+chElId+'" name="'+chElName+'" value="'+defaultVal+'" class="cuselValueCustom" />'+
					'</div>'+
					'</div>';
...
jQuery("html").click(
	function(e)
	{
		...
		else if(clicked.is(".cusel-scroll-wrap span") && clickedClass.indexOf("cuselActive")==-1)
		{
			...
			clicked.parents(".cusel-scroll-wrap").find(".cuselValueCustom").val(clickedVal);
