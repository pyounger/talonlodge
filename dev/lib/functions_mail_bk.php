...
function emailToCustomer($email, $password, $name){
	...
	//$fromMail = "noreply@talonlodge.com";
...
function profile_completed_updated($email, $name, $id, $grp, $comp_upd){
	...
	$welcome = 'Phil,
        <br> 
        A profile for '.$name.' has been '.$comp_upd.' online for '.$grp.'. Click the link below to view it. <br><br>
	<a href="http://private.talonlodge.com/guests/profile_report.asp?profileid='.$id.'">CLICK HERE</a> <br>
	...
	<br><br>';
        ...
        $headers = "From: Talon Lodge <" . strip_tags($fromMail) . ">\r\n";
	$headers .= "Reply-To: <noreply@talonlodge.com>, <GuestServices@talonlodge.com>, <gyounger@talonlodge.com>, <phil@talonlodge.com>" . "\r\n";
	$headers .= "MIME-Version: 1.0\r\n";
	$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";  
    @mail($email, $subject, $message, $headers);
}
