   ...
   ***********************************************************************************/ 
   function pageList($curpage, $pages, $qryString) 
    { 
     ...
     if (($curpage-1) > 0) 
      { 
		$page_list .= "<li class=\"arrowleft\"><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage-1).$qryString."\" title=\" Previous Page ".($curpage-1)."\">".""."</a></li>";	  
     ...
     if (($curpage+1) <= $pages) 
      { 
		$page_list .= "<li class=\"arrowright\"><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage+1).$qryString."\" title=\" Next Page ".$i."\">".""."</a></li>";	  
