...
if (isset($_REQUEST['btnAdd'])) {
    $isexist = chkExist("msch_id", "menu_schedules", " WHERE cont_id=".$_REQUEST['cont_id']." AND grp_id=".$_REQUEST['grp_id']." AND pms_pak_id=".$_REQUEST['pms_pak_id']." AND act_id=".$_REQUEST['act_id']." ");
    if($isexist>0){
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Eating Schedule <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Eating Schedule: </b> You can manage your Eating Schedule here </p>
        </blockquote>
    </div>
</div>
                            ...
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="example" >
                                <thead>
                                    <tr>
                                        ...
                                        <th class="visible-xs visible-sm visible-md visible-lg">Custom Breakfast</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Custom Lunch</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Custom Dinner</th>
...
ORDER BY c.ContactFirstName ";
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_b" style="width: 110px;" >
                                                        ...
                                                        <?php 
                                                            $men_b = returnName("menu_b", "menu_default_pkg", "pms_pak_id", $row->Pms_Package_ID.' AND cont_id = '.$row->ContactID);
                                                            echo FillSelected("menus WHERE menu_type=1 ", "menu_id", "menu_item_name", (($men_b!='')?$men_b:@$row->menu_b));
                                                        ?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_l" style="width: 110px;" >
                                                        <option value="0">Select</option>
                                                        <?php 
                                                            $men_l = returnName("menu_l", "menu_default_pkg", "pms_pak_id", $row->Pms_Package_ID.' AND cont_id = '.$row->ContactID);
                                                            echo FillSelected("menus WHERE menu_type=2 ", "menu_id", "menu_item_name", (($men_l!='')?$men_l:@$row->menu_l));?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_d" style="width: 110px;" >
                                                        <option value="0">Select</option>
                                                        <?php 
                                                            $men_d = returnName("menu_d", "menu_default_pkg", "pms_pak_id", $row->Pms_Package_ID.' AND cont_id = '.$row->ContactID);
                                                            echo FillSelected("menus WHERE menu_type=3 ", "menu_id", "menu_item_name", (($men_d!='')?$men_d:@$row->menu_d));
                                                        ?>
                                                    </select>
                                                </td>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    ...
                                                    <input type="hidden" name="cont_id" value="<?php echo  $row->ContactID;?>" >
                                                    <input type="submit" value="Set" name="addCustMenuRec" class="btn bg-primary text-white">
                                                </td>
                                                </form>
                                            </tr>
                            <?php
        ...
        <?php
                ...
                if( isset($_REQUEST['msch_id']) && $_REQUEST['msch_id']!='' ){
                    
                $rsM = mysql_query("SELECT 
                msc.msch_id, msc.msch_date, msc.menu_id,
                mi.menu_item_name,
                c.ContactFirstName, c.ContactLastName, g.GroupName, p.Package_Name
                FROM menu_schedules AS msc
                LEFT OUTER JOIN contacts AS c ON msc.cont_id=c.ContactID
                LEFT OUTER JOIN groups AS g ON msc.grp_id=g.grp_id
                LEFT OUTER JOIN packages AS p ON msc.pms_pak_id=p.Pms_Package_ID
                LEFT OUTER JOIN menus AS mi ON msc.menu_id=mi.menu_id
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-9 det-display">
                                <?php 
                                    $counter=0;
                                    $rsM = mysql_query("SELECT b.bitem_name FROM bar_items AS b LEFT OUTER JOIN menus_lov AS ml ON b.bitem_id=ml.bitem_id WHERE ml.menu_id=" . $rsMem->menu_id);
                                    if (mysql_num_rows($rsM) > 0) {
                                        echo '&nbsp; ';
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Eating Schedule
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
