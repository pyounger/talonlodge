...
<table border="0" width="100%"  cellspacing="2" cellpadding="0">
	...
	<h1 class="heading_class"><?php if($id!=''){ echo "Edit "; } else { echo "Add "; }?>Subcategory</h1>
	<tr>
		<td style=\"align:left\">
...
<tr><td><form name="myform" action="save_edit_delprofile.php?type=sub_cat_add" method="post" >
<table>
...
?>
    <td class="tab-add" style="margin-top:12px;">Category</td>
    <td class="tab" style="width:529px;"><select name='cat_id' id='cat_id' >
<?php
...
?>
    ...
    <td class="tab"><div class="button"><a href="category.php" style="color:#fff; text-decoration:none;">Manage Category</a></div>
			<?php
  ...
  <tr>
    <td class="tab-add" style="margin-top:12px;">Sub-Category:</td>
    <td class="tab"><input type="text" name="sub_cat_name" id="sub_cat_name" /></td>
    <td class="tab">&nbsp;</td>
  </tr>
 ...
 <tr>
    <td class="tab-add">&nbsp;</td>
    <td class="tab"><input type="button" name="btncancel" value="Cancel" class="button" onClick="cancelapplication('sub_category.php')"/>
...
<tr>
	<td colspan="2" style="padding-right:472px">
