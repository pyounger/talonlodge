...
---------------------------------------------------------------------------------------*/
	...
	$numrecords = $theData;
function doPagesnotes($page_size, $thepage, $query_string, $total=0) {
    ...
    //end of method doPages()
	/* Extract Filename */
	function extractfilename($parm)
	{
		$arrayelems = explode("/",$parm);
		$filenamewithqs = $arrayelems[count($arrayelems)-1];
		$filename = explode("?",$filenamewithqs);
		return $filename[0];
	}
?>