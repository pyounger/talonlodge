                ...
                if ($same_mem_again != '') {
                    ...
                    if ($same_mem_again_another_room != '') {
                        ...
                        if (isset($_REQUEST['add'])) {
                            ...
                            $interval = DateInterval::createFromDateString('1 day');
                            //$interval = date("d-m-Y H:i:s",strtotime("1 day"));
                            ...
                            foreach ($period as $dt):
                                ...
                                if ($day_counter != 1) {
                                    if ($no_of_days == $day_counter) {
                                        ...
                                        $day_counter1++;
                                        //echo 'Day '.$day_counter1.'<br/>'.$dt->format( "d/m/Y" );
...
ORDER BY p.Arrival_Start_Date ASC";
                                    ...
                                    if (mysql_num_rows($rs) > 0) {
                                        while ($row = mysql_fetch_object($rs)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg"><?php echo 'Jacket Size: ' . $row->jacketsize_name . '<br/> Boot Size: ' . $row->bootsize_id; ?></td>
                                                <?php
                                                $day_counter = 0;
                                                $day_counter1 = 0;
                                                $date1 = '';
															...
															AND roomr_startdate= '" . $dt->format("Y-m-d") . "' ";
                                                                ...
                                                                if ($count1 > 0) {
                                                                    ...
                                                                    = mysql_fetch_object($rs1)) {
                                                                        ...
                                                                        echo $row1->room_title . '<br/><a href=' . $_SERVER['PHP_SELF'] . "?delete=1&roomr_id=" . $row1->roomr_id . "&show=1&pms_pak_id=" . $row->Pms_Package_ID . "&contactid=" . $row->ContactID . '>Unassign</a>';
                                                                    }
                                                                } else {
                                                                    $day_counter1++;
        ...
        ?>
                                                ...
                                                <?php
                                            } else if (isset($_REQUEST['show']) && $_REQUEST['show']
                                                    == 2) {
                                                ?>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="example" >
                                ...
                                <tbody>
                                    ...
                                    <?php print($row->Package_Name); ?>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg"><?php print($row->Arrival_Start_Date); ?></td>
                                                <td class="visible-xs visible-sm visible-md visible-lg"><?php print($row->Arrival_End_Date); ?></td>
