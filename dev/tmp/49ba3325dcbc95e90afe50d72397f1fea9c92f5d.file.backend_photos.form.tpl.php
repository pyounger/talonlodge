<?php /* Smarty version Smarty-3.0.8, created on 2015-12-04 12:28:05
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_photos.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8331155875662056512a952-30262250%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49ba3325dcbc95e90afe50d72397f1fea9c92f5d' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_photos.form.tpl',
      1 => 1449264481,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8331155875662056512a952-30262250',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.photos.editing_photo<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>

	<?php }else{ ?>

		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.banners.adding_photo<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.photos.photos'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
...
$_template->properties['nocache_hash']  = '8331155875662056512a952-30262250';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="thumbnail" style="width: <?php echo $_smarty_tpl->getVariable('versions')->value['backend_thumb']['width'];?>
px;">

                <img src="<?php echo cpf_config('APP.PHOTOS.URLS.BACKEND');?>
<?php echo $_smarty_tpl->getVariable('versions')->value['backend_thumb']['filename'];?>
" width="<?php echo $_smarty_tpl->getVariable('versions')->value['backend_thumb']['width'];?>
" height="<?php echo $_smarty_tpl->getVariable('versions')->value['backend_thumb']['height'];?>
...
">
    ...
    <?php if ($_smarty_tpl->getVariable('slideshow_positions')->value){?>

        <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'select','field'=>'slideshow_position','list'=>$_smarty_tpl->getVariable('slideshow_positions')->value));?>


    <?php }?>

	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'text','field'=>'alt'));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'text','field'=>'atitle'));?>
