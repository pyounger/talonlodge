<?php /* Smarty version Smarty-3.0.8, created on 2015-01-21 06:42:20
         compiled from "/home2/talonlod/public_html/app/templates/controls/menu_custom/main_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5551164454bfc8dc4d0fd1-90988217%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31168cf8bf15ed3e3afed999f3ee7563d3a8ce6c' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/controls/menu_custom/main_menu.tpl',
      1 => 1417641646,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5551164454bfc8dc4d0fd1-90988217',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['menu']['iteration']==2){?> first<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['menu']['last']){?> last<?php }?>">
...
<?php  Smarty::$_smarty_vars['capture']['submenu_name']=ob_get_clean();?>
				<?php ob_start(); ?>
					<li <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['menu']['last']){?> class="last"<?php }?>>
						<a rel="<?php echo $_smarty_tpl->getVariable('item')->value->filename;?>
...
<?php  Smarty::$_smarty_vars['capture']['file_name']=ob_get_clean();?>
				<?php ob_start(); ?><?php echo $_smarty_tpl->getVariable('temp_filename')->value;?>
<?php  $_smarty_tpl->assign(Smarty::$_smarty_vars['capture']['file_name'], ob_get_contents()); Smarty::$_smarty_vars['capture']['default']=ob_get_clean();?>

				<?php ob_start(); ?>text_<?php echo $_smarty_tpl->getVariable('iteration')->value;?>
<?php  Smarty::$_smarty_vars['capture']['text']=ob_get_clean();?>
				<?php ob_start(); ?><?php echo $_smarty_tpl->getVariable('temp_text')->value;?>
<?php  $_smarty_tpl->assign(Smarty::$_smarty_vars['capture']['text'], ob_get_contents()); Smarty::$_smarty_vars['capture']['default']=ob_get_clean();?>
						...
						<div class="b-slidedown-inner">
							<div class="b-slidedown-inner-l">
								<div class="b-slidedown-inner-r">
									<div class="b-about-us-inner">
										<?php if ($_smarty_tpl->getVariable('filename')->value){?>
										<a href="#" class="b-slidedown-submenu-image"><img src="<?php echo cpf_config('APP.NAVIGATION.URL');?>
...
" />
										<?php }?>
										<ul<?php if (!$_smarty_tpl->getVariable('filename')->value){?> class="wide"<?php }?>>
...
<?php }} ?>
									...
									<p><?php echo $_smarty_tpl->getVariable('text')->value;?>
</p>
								</div>
							</div>
						</div>
						<div class="b-slidedown-bottom-l"><div class="b-slidedown-bottom-r"><div class="b-slidedown-bottom-c"></div></div></div>
					</div>
				<?php }?>
