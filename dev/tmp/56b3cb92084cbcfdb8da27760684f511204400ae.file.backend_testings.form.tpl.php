<?php /* Smarty version Smarty-3.0.8, created on 2017-02-09 15:23:26
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_testings.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1075086304589d07fe8e1477-15344538%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56b3cb92084cbcfdb8da27760684f511204400ae' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_testings.form.tpl',
      1 => 1486682279,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1075086304589d07fe8e1477-15344538',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
Edit Recipe<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>

	<?php }else{ ?>

		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
New Recipe<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
...
$_template->properties['nocache_hash']  = '1075086304589d07fe8e1477-15344538';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
	...
	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"title",'class'=>"span8"));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"slug",'field'=>"slug",'title_field'=>'title','class'=>"span8"));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"serves",'class'=>"span8"));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"prep_time",'class'=>"span8"));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"cook_time",'class'=>"span8"));?>


	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>"multiple_select",'field'=>"meal_type",'list'=>$_smarty_tpl->getVariable('meal_types')->value,'value'=>$_smarty_tpl->getVariable('categories_values')->value,'label'=>t('tables.recipes.meal_type')));?>


	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>"multiple_select",'field'=>"fish_type",'list'=>$_smarty_tpl->getVariable('fish_types')->value,'value'=>$_smarty_tpl->getVariable('categories_values')->value,'label'=>t('tables.recipes.fish_type')));?>


	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>"multiple_select",'field'=>"technique_type",'list'=>$_smarty_tpl->getVariable('technique_types')->value,'value'=>$_smarty_tpl->getVariable('categories_values')->value,'label'=>t('tables.recipes.technique_type')));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"ck_editor",'field'=>"ingredients",'loadJS'=>true));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"ck_editor",'field'=>"directions"));?>


	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"ck_editor",'field'=>"nutritional"));?>
...
<?php echo $_smarty_tpl->getVariable('filename_thumb')->value;?>
" />
