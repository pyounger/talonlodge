<?php /* Smarty version Smarty-3.0.8, created on 2015-12-02 14:54:47
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_galleries.view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1731245730565f84c7de90b0-61412835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f484a24b30b6bcb2efe507c478c23c635883b02' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_galleries.view.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
    'a95f5803ce97e4ffc1127e6527bcb9c64dea195d' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/layouts/backend.view.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1731245730565f84c7de90b0-61412835',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
<head>
	<title>
		<?php ob_start(); ?>
    <?php ob_start(); ?><?php echo $_smarty_tpl->getVariable('entity')->value->title;?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.galleries.galleries'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array($_tmp1,'')), null, null);?>
    ...
    <?php if ($_smarty_tpl->getVariable('page_id')->value){?>
        <?php ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_pages','action'=>'view','id'=>$_smarty_tpl->getVariable('page_id')->value),$_smarty_tpl);?>
<?php  Smarty::$_smarty_vars['capture']['back_url']=ob_get_clean();?>
        <?php ob_start(); ?><?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.pages.back_to_the_page'),'url'=>Smarty::$_smarty_vars['capture']['back_url']));?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['back_button']);$_template->properties['nocache_hash']  = '1731245730565f84c7de90b0-61412835';
...
<?php $_smarty_tpl = array_pop($_tpl_stack);?><?php unset($_template);?>
    ...
    <div class="row">
        <table class="span7 table-condensed">
            <tr>
                <td><h2><?php echo $_smarty_tpl->getVariable('entity')->value->title;?>
</h2><span class="label label-info"><?php echo $_smarty_tpl->getVariable('entity')->value->gallerytype->title;?>
</span></td>
            </tr>
            <?php if ($_smarty_tpl->getVariable('entity')->value->description){?>
            <tr>
                <td><?php echo $_smarty_tpl->getVariable('entity')->value->description;?>
</td>
            </tr>
            <?php }?>
        </table>
    ...
    <div class="well">
        <h3><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.galleries.items<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h3>
        <br />
        <?php smarty_template_function_cpf_button($_smarty_tpl,array('class'=>"btn-primary",'icon'=>'plus-sign icon-white','title'=>t('backend.galleries.add_photos'),'url'=>cpf_link(array('controller'=>'backend_photos','action'=>'add','id'=>$_smarty_tpl->getVariable('entity')->value->id,'table'=>'App_Model_Gallery'))));?>


        <?php if (count($_smarty_tpl->getVariable('entity')->value->photos)>0){?>
            <div class="clearfix">
                <br />
                <ul class="thumbnails gallery-photos">
                    <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('entity')->value->photos; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
if ($_smarty_tpl->tpl_vars['item']->total > 0){
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['gphotos']['first'] = $_smarty_tpl->tpl_vars['item']->first;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['gphotos']['last'] = $_smarty_tpl->tpl_vars['item']->last;
?>
                        <li class="span2" id="photo-<?php echo $_smarty_tpl->getVariable('item')->value->id;?>
">
                            <div class="thumbnail">
                                <img src="<?php echo cpf_config('APP.PHOTOS.URLS.BACKEND');?>
<?php echo $_smarty_tpl->getVariable('item')->value->versions['backend_thumb']['filename'];?>
" width="<?php echo $_smarty_tpl->getVariable('item')->value->versions['backend_thumb']['width'];?>
" height="<?php echo $_smarty_tpl->getVariable('item')->value->versions['backend_thumb']['height'];?>
" alt="<?php echo $_smarty_tpl->getVariable('item')->value->title;?>
">
                                <br />
                                <p style="text-align: center"><?php echo (($tmp = @$_smarty_tpl->getVariable('item')->value->title)===null||$tmp==='' ? '&nbsp;' : $tmp);?>
</p>
                                <div style="text-align: center">
                                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_photos','action'=>"edit",'id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
" class="btn btn-success"><i class="icon-edit icon-white"></i></a>
                                    <a target="_blank" href="<?php echo cpf_config('APP.PHOTOS.URLS.FRONTEND');?>
<?php echo $_smarty_tpl->getVariable('item')->value->versions['fullscreen']['filename'];?>
" class="btn btn-primary"><i class="icon-zoom-in icon-white"></i></a>
                                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_photos','action'=>"delete",'id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
" class="btn btn-danger"><i class="icon-remove icon-white"></i></a>
                                </div>
								<div style="padding: 3px 0 0 0; text-align: center;">
                                <a target="_blank" href="<?php echo cpf_config('APP.PHOTOS.URLS.FRONTEND');?>
<?php echo $_smarty_tpl->getVariable('item')->value->versions['original']['filename'];?>
"><small>original image</small></a>
								</div>
...
<?php  Smarty::$_smarty_vars['capture']['confirm']=ob_get_clean();?>
        <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'edit')){?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.common.edit'),'class'=>'btn-success','icon'=>'edit icon-white','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'edit','id'=>$_smarty_tpl->getVariable('entity')->value->id))));?>

        <?php }?>
        <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'delete')){?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.common.delete'),'class'=>'btn-danger','icon'=>'trash icon-white','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'delete','id'=>$_smarty_tpl->getVariable('entity')->value->id)),'onclick'=>"return confirm('".(Smarty::$_smarty_vars['capture']['confirm'])."');"));?>
    ...
    jQuery(document).ready(function($)
    {
        ...
        $(".thumbnails").bind('sortstop', function(event, ui) {
            ...
            // send ajax request
                $.ajax({
                    type: "POST",
                    url: '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_photos','action'=>'ajax_move','abs'=>true),$_smarty_tpl);?>
',
                    data: { ids: ids.join('-') },
                    success: function(){}
                });
