<?php /* Smarty version Smarty-3.0.8, created on 2017-08-23 14:35:26
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_twitter.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1109550035599e032e7f7622-51082786%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f9ffc20d7d0f8d09169149944a08bd5ff864043' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_twitter.default.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1109550035599e032e7f7622-51082786',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
if (!is_callable('smarty_modifier_datetime_format')) include '/home2/talonlod/public_html/dev/cpf/core/view/smarty/plugins/modifier.datetime_format.php';
if (!is_callable('smarty_modifier_truncate')) include '/home2/talonlod/public_html/dev/cpf/libs/smarty/plugins/modifier.truncate.php';
...
backend.twitter.reviews<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array($_tmp1,'')), null, null);?>
    ...
    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'add')){?>
        <?php ob_start(); ?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.twitter.load_reviews'),'icon'=>'retweet','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'load'))));?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '1109550035599e032e7f7622-51082786';
...
" class="table table-striped">
    ...
    <?php if (!empty($_smarty_tpl->getVariable('cpf_entities',null,true,false)->value)){?>
        ...
        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'priority'));?>


        <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'toggle_published')){?>
            <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'is_published','no_link'=>true));?>

        <?php }?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'title','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'date','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'content','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'key','no_link'=>true));?>

        <?php $_smarty_tpl->tpl_vars['show_actions'] = new Smarty_variable(false, null, null);?>
        <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'view')||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'edit')||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'delete')||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'up')||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'down')){?>
...
">
        <td class="span1"><?php echo $_smarty_tpl->getVariable('item')->value->priority;?>
</td>
        <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'toggle_published')){?>
        <td class="span1">
...
"></a>
        ...
        <td class="span2">
            <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'view')){?>
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>"view",'id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
        ...
        <td class="span1"><?php echo smarty_modifier_datetime_format($_smarty_tpl->getVariable('item')->value->date,$_smarty_tpl->getVariable('cpf_langs')->value[$_smarty_tpl->getVariable('cpf_lang')->value]['date_format']);?>
</td>
        <td class="span4"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->getVariable('item')->value->content),200);?>
</td>
        ...
        <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
            <td>
                <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'view')){?>
                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'view','id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><i class="icon-info-sign"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.common.view<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
                <?php }?>
...
backend.common.delete<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'up')||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'down')){?>
                    <br /><br />
                    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'up')){?>
...
backend.common.move_up<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                        ...
                        <?php }?>
                    <?php }?>
                    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'down')){?>
