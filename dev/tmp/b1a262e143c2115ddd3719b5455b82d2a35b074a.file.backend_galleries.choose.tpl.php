<?php /* Smarty version Smarty-3.0.8, created on 2016-10-11 15:37:48
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_galleries.choose.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121228920957fd77cc5490f4-39242393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1a262e143c2115ddd3719b5455b82d2a35b074a' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_galleries.choose.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '121228920957fd77cc5490f4-39242393',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '121228920957fd77cc5490f4-39242393';
...
">
            <td><input type="checkbox" class="checkbox" name="galleries[]" id="gallery-<?php echo $_smarty_tpl->getVariable('item')->value->id;?>
" value="<?php echo $_smarty_tpl->getVariable('item')->value->id;?>
"<?php if (in_array($_smarty_tpl->getVariable('item')->value->id,$_smarty_tpl->getVariable('galleries_ids')->value)){?> checked="checked"<?php }?> /></td>
...
?>—<?php endfor; endif; ?> <?php }?>
    ...
    <?php }} ?>
        ...
        <?php if (!empty($_smarty_tpl->getVariable('cpf_entities',null,true,false)->value)){?>
            ...
            <?php smarty_template_function_cpf_submit($_smarty_tpl,array('title'=>t('backend.galleries.add_to_page'),'icon'=>'plus-sign icon-white'));?>

            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.common.cancel'),'icon'=>'ban-circle','url'=>cpf_link(array('controller'=>'backend_pages','action'=>'view','id'=>$_smarty_tpl->getVariable('page_id')->value))));?>
