<?php /* Smarty version Smarty-3.0.8, created on 2015-01-30 06:24:25
         compiled from "/home2/talonlod/public_html/app/templates/backend_navigation.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12362126354cba229bc27b4-83449520%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c920a5a2b01a0dc39ecba54bb2d3af134ff779a3' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/backend_navigation.default.tpl',
      1 => 1333505742,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12362126354cba229bc27b4-83449520',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.navigation.menu<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array($_tmp1,'')), null, null);?>
    ...
    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'add')){?>
        <?php ob_start(); ?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.navigation.add_menu'),'icon'=>'plus-sign','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'add'))));?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '12362126354cba229bc27b4-83449520';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2015-01-30 06:24:26
...
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
        ...
        <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
            <td>
                <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights('backend_navigationelements','view')){?>
                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_navigationelements','action'=>'view','id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><i class="icon-list"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.navigation.items<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
                <?php }?>
