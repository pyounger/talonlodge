<?php /* Smarty version Smarty-3.0.8, created on 2018-01-08 11:54:39
         compiled from "/home2/talonlod/public_html/dev/app/templates/frontend_contacts.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15976461185a53da8f2eb580-62563843%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87ccd806bdd5c6e20177ffed63f7c0efa2fa5cce' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/frontend_contacts.default.tpl',
      1 => 1515444871,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15976461185a53da8f2eb580-62563843',
  'function' => 
  array (
    'cpf_validator' => 
    array (
...
<div class="h-contactus-wrapper l-center">
    ...
    <div class="b-contactus-r">
        ...
        <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('rule'=>'frontend_contacts'),$_smarty_tpl);?>
            ...
            <div class="b-contactus-form-l">
                ...
                <div class="b-brochure-input-r">
                    ...
                    <div class="b-brochure-input-l">
                        ...
                        <input type="text" id="first_name" name="first_name" maxlength="255" value="<?php echo $_smarty_tpl->getVariable('first_name')->value;?>
" />
                ...
                <div class="b-brochure-input-r">
                    ...
                    <div class="b-brochure-input-l">
                        ...
                        <input type="text" id="last_name" name="last_name" maxlength="255" value="<?php echo $_smarty_tpl->getVariable('last_name')->value;?>
" />
                ...
                <div class="b-brochure-input-r">
                    ...
                    <div class="b-brochure-input-l">
                        ...
                        <input type="text" id="email" name="email" maxlength="255" value="<?php echo $_smarty_tpl->getVariable('email')->value;?>
" />
...
" width="95" height="42" alt=""/>
            ...
            <div class="b-contactus-form-r">
                ...
                <textarea id="message" name="message"><?php echo $_smarty_tpl->getVariable('message')->value;?>
</textarea>
