<?php /* Smarty version Smarty-3.0.8, created on 2016-10-11 16:26:56
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_videos.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:72435516257fd8350b80ef7-35260754%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3d1844d93f4c00cc884b1ebc30c4a07ad1e502b' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_videos.form.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '72435516257fd8350b80ef7-35260754',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.videos.editing_video<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
        <?php }else{ ?>
        <?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.videos.adding_video<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
    <?php }?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
...
$_template->properties['nocache_hash']  = '72435516257fd8350b80ef7-35260754';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
    ...
    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"service_id"));?>

    <div class="control-group">
        <label></label>
        <div class="controls">
            <a href="#" class="b-how-to-get-video-id"><?php echo t('How to get a YouTube video ID?');?>
</a>
        </div>
    <div class="control-group">
        <label></label>
        <div class="controls">
            <img src="static/images/backend/project/youtube_video_id.jpg" width="492" height="121" alt="<?php echo t('How to get a YouTube video ID?');?>
" class="b-youtube-video-id" style="display: none;"/>
        </div>
    </div>
    <div class="control-group">
        <label></label>
        <div class="controls">
            <div class="b-video-wrap" <?php if (!$_smarty_tpl->getVariable('cpf_is_edit')->value){?>style="display: none;"<?php }?>>
                <?php smarty_template_function_cpf_youtube_video_iframe($_smarty_tpl,array('youtube_id'=>$_smarty_tpl->getVariable('cpf_current_entity')->value->youtube_id));?>

            </div>
            <div class="buttons">
                <?php smarty_template_function_cpf_button($_smarty_tpl,array('href'=>"#",'class'=>"positive b-refresh",'title'=>"Refresh"));?>

            </div>
        </div>
    </div>

    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"width"));?>

    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"height"));?>
...
var template = '<?php smarty_template_function_cpf_youtube_video_iframe($_smarty_tpl,array('youtube_id'=>"***"));?>
';
