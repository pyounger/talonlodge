<?php /* Smarty version Smarty-3.0.8, created on 2016-11-02 11:42:00
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_reviews.view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:588900986581a418840f467-01662880%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f51becd901137ebe9433315ecfc98bd5ef62d9a' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_reviews.view.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '588900986581a418840f467-01662880',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
<?php if (!is_callable('smarty_modifier_datetime_format')) include '/home2/talonlod/public_html/dev/cpf/core/view/smarty/plugins/modifier.datetime_format.php';
...
backend.reviews.review<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.reviews.reviews'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array($_tmp1,'')), null, null);?>
...
<?php  Smarty::$_smarty_vars['capture']['back_url']=ob_get_clean();?>
    ...
    <div class="row">
        <table class="span7 table-condensed">
            ...
            <tr>
                <td><h5><?php echo smarty_modifier_datetime_format($_smarty_tpl->getVariable('entity')->value->date,$_smarty_tpl->getVariable('cpf_langs')->value[$_smarty_tpl->getVariable('cpf_lang')->value]['date_format']);?>
</h5></td>
            </tr>
            <tr>
                <td><?php echo $_smarty_tpl->getVariable('entity')->value->content;?>
</td>
            </tr>
        </table>
    </div>
