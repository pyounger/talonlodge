<?php /* Smarty version Smarty-3.0.8, created on 2015-12-05 12:04:18
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_messages.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129127124556635152a44906-25607086%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be15b28e420f820dc01048de0262685ea62fbfdb' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_messages.default.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '129127124556635152a44906-25607086',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.messages.messages<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '129127124556635152a44906-25607086';
...
" class="table table-striped">
    ...
    <?php if (!empty($_smarty_tpl->getVariable('cpf_entities',null,true,false)->value)){?>
        ...
        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'email','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'datetime','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'first_name','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'last_name','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'message','no_link'=>true));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'ip','no_link'=>true));?>
...
">
        <td class="span1"><?php echo $_smarty_tpl->getVariable('item')->value->id;?>
</td>
        <td class="span1"><a href="mailto:<?php echo $_smarty_tpl->getVariable('item')->value->email;?>
"><?php echo $_smarty_tpl->getVariable('item')->value->email;?>
</a></td>
        <td class="span1"><?php echo smarty_modifier_datetime_format($_smarty_tpl->getVariable('item')->value->datetime,$_smarty_tpl->getVariable('cpf_langs')->value[$_smarty_tpl->getVariable('cpf_lang')->value]['date_format']);?>
</td>
        <td><?php echo $_smarty_tpl->getVariable('item')->value->first_name;?>
</td>
        <td><?php echo $_smarty_tpl->getVariable('item')->value->last_name;?>
</td>
        <td class="span3"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->getVariable('item')->value->message),200);?>
</td>
        <td><?php echo $_smarty_tpl->getVariable('item')->value->ip;?>
</td>
        <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
            <td>
