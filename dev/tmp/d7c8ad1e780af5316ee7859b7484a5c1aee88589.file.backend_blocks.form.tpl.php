<?php /* Smarty version Smarty-3.0.8, created on 2015-12-11 09:21:47
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_blocks.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1302473482566b143b5ec039-14937086%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7c8ad1e780af5316ee7859b7484a5c1aee88589' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_blocks.form.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1302473482566b143b5ec039-14937086',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.blocks.editing_block<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }else{ ?>
		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.blocks.adding_block<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }?>
...
backend.blocks.required_content<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' }
		}
...
$_template->properties['nocache_hash']  = '1302473482566b143b5ec039-14937086';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
    ...
    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'hidden','field'=>'page_placeholder'));?>
