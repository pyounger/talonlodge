<?php /* Smarty version Smarty-3.0.8, created on 2015-11-09 15:18:40
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_pages.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1217280080564137e09729c6-70355824%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88037db41893a08bd001ec84409cd77c4b2d329d' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_pages.default.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1217280080564137e09729c6-70355824',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.pages.pages<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array($_tmp1,'')), null, null);?>
    ...
    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'add')){?>
        <?php ob_start(); ?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.pages.add_page'),'icon'=>'plus-sign','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'add'))));?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '1217280080564137e09729c6-70355824';
...
" class="table table-striped">
    ...
    <?php if (count($_smarty_tpl->getVariable('cpf_entities')->value)>1){?>
        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'id','title'=>t('tables.pages.id')));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'type','title'=>t('tables.pages.is_published')));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'type','title'=>t('tables.pages.type')));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'title','title'=>t('tables.pages.title')));?>
...
"></a>
            ...
            <?php }?>
            <td><?php if ($_smarty_tpl->getVariable('item')->value->type=='component'){?><i class="icon-th-large"></i><?php }elseif($_smarty_tpl->getVariable('item')->value->type=='content'){?><i class="icon-file"></i><?php }?></td>
            <td class="span5">
...
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
            ...
            <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
                <td>
                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'view','id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><i class="icon-list-alt"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
tables.pages.content<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
                    &nbsp;
                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'slideshow','id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><i class="icon-picture"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.pages.slideshow<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a>
                    &nbsp;
