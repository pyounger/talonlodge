<?php /* Smarty version Smarty-3.0.8, created on 2015-12-04 08:47:17
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_photos.add_2_gallery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11663057105661d1a5bf8943-84945471%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5439402a28ef9dd3bb93d5fa157637fe77fac1b3' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_photos.add_2_gallery.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11663057105661d1a5bf8943-84945471',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.galleries.galleries'),cpf_link(array('controller'=>'backend_galleries','action'=>'view','id'=>$_smarty_tpl->getVariable('gallery')->value->id))),array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
	<?php ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_galleries','action'=>'view','id'=>$_smarty_tpl->getVariable('gallery')->value->id),$_smarty_tpl);?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['back_button']);$_template->properties['nocache_hash']  = '11663057105661d1a5bf8943-84945471';
...
<?php $_smarty_tpl = array_pop($_tpl_stack);?><?php unset($_template);?>
    ...
    <div class="container">
        ...
        <form id="fileupload" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'upload_2_gallery','id'=>$_smarty_tpl->getVariable('gallery')->value->id),$_smarty_tpl);?>
