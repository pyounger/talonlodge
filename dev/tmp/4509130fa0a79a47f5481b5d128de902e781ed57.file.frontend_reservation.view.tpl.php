<?php /* Smarty version Smarty-3.0.8, created on 2017-12-27 01:34:40
         compiled from "/home2/talonlod/public_html/dev/app/templates/frontend_reservation.view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7487016805a04c86435ec41-49270806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4509130fa0a79a47f5481b5d128de902e781ed57' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/frontend_reservation.view.tpl',
      1 => 1510262816,
      2 => 'file',
    ),
    'da91add4db94ec601ce884fbce08aea32eae0293' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/layouts/frontend.tpl',
      1 => 1514330728,
      2 => 'file',
    ),
    'c30df85e09c67b666e6592de139111f72b624ce5' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/includes/frontend.ui/frontend.errors.tpl',
      1 => 1509742600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7487016805a04c86435ec41-49270806',
  'function' => 
  array (
    'cpf_validator' => 
    array (
...
if (!is_callable('smarty_modifier_date_format')) include '/home2/talonlod/public_html/dev/cpf/libs/smarty/plugins/modifier.date_format.php';
...
.css" rel="stylesheet"  media="screen" />
    ...
    <link rel="stylesheet" type="text/css" href="http://www.dev.talonlodge.com/static/css/frontend/gallery/gallery-view.css">
   <!--  <link rel="stylesheet" type="text/css" href="http://www.dev.talonlodge.com/static/css/frontend/gallery/fancy-gallery.css"> -->
    <script type="text/javascript" src="http://www.dev.talonlodge.com/static/javascript/frontend/fancygallery/galleryjquery.js"></script>
    <script type="text/javascript" src="http://www.dev.talonlodge.com/static/javascript/frontend/fancygallery/galleryfancy.js"></script>
    <!-- ...........end gallery css & js............... -->
...
$(document).ready(function(){
    // $(".viewmdl").click(function(){
    //     //alert($("#murl").data("source"));

    //     $("#viewframe").attr("src", $(".murl").data("source"));
    //     $("#vmd").show();
    // });
...
<div class="b-reservation-view-wrapper l-center">
    ...
    <?php }?>
<!--      <div>
        <a id = "preve" class="b-reservation-view-confirm" href="#confirm"">Reservation Request</a>
    </div> -->
    <div class="btns">
       <!--  <a id = "preve" href = "http://www.dev.talonlodge.com/reservation/<?php if ($_smarty_tpl->getVariable('web')->value=='bluffhouse'){?>?&adults=<?php echo $_smarty_tpl->getVariable('adults')->value;?>
&web=bluffhouse<?php }?>">Previous Page</a> -->

        <a id = "preve" href = "http://www.dev.talonlodge.com/reservation/?start=<?php echo $_smarty_tpl->getVariable('start')->value;?>
...
$_template->properties['nocache_hash']  = '7487016805a04c86435ec41-49270806';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2017-12-27 01:34:40
         compiled from "/home2/talonlod/public_html/dev/app/templates/includes/frontend.ui/frontend.errors.tpl" */ ?>
<style type="text/css">
...
?>
		...
		<!-- <li><p class="b-contacts-success"><?php echo $_smarty_tpl->tpl_vars['error']->value;?>
</p></li> -->
...
<?php /*  End of included template "/home2/talonlod/public_html/dev/app/templates/includes/frontend.ui/frontend.errors.tpl" */ ?>
<?php $_smarty_tpl = array_pop($_tpl_stack);?><?php unset($_template);?>
 ...
 - <?php echo $_smarty_tpl->getVariable('PackageDetailByID')->value[0]['Type_Of_Adventure'];?>
                       ...
                       <!--  <span>
                            Minimum 
                            <?php if ($_smarty_tpl->getVariable('package')->value->Package_Min_People==1){?>
                            Single Occupancy
                            <?php }elseif($_smarty_tpl->getVariable('package')->value->Package_Min_People==2){?>
                            Double Occupancy
                            <?php }elseif($_smarty_tpl->getVariable('package')->value->Package_Min_People==3){?>
                            Triple Occupancy
                            <?php }elseif($_smarty_tpl->getVariable('package')->value->Package_Min_People==4){?>
                            Quad Occupancy
                            <?php }else{ ?> 
                            <?php echo $_smarty_tpl->getVariable('package')->value->Package_Min_People;?>
 People 
                            <?php }?> /
                        ...
                        <!-- <span>
                            Minimum Group Size <?php echo $_smarty_tpl->getVariable('package')->value->Package_Min_Adults;?>

                        </span> Remove for new doc(Parvez)--></br>
                      <!--   <span> <?php echo $_smarty_tpl->getVariable('Resource_Name')->value;?>
 ---<?php echo $_smarty_tpl->getVariable('Resource_id')->value;?>
</span> -->
                        <!-- <span> <?php echo $_smarty_tpl->getVariable('Resource_Name')->value;?>
 </span> -->
                         <span>
                                <!-- The Bluff House -->
                                 <!-- Remove for new doc(Parvez) -->
                           </span>
                ...
                <!-- <pre>
                <?php echo smarty_modifier_debug_print_var($_smarty_tpl->getVariable('PackageDetailByID')->value);?>
</pre> -->
...
?>
 ...
 to $<?php echo smarty_modifier_truncate($_smarty_tpl->getVariable('HighestRate')->value,4,'');?>
                     ...
                     <!-- <span>$<?php echo smarty_modifier_truncate($_smarty_tpl->getVariable('package')->value->resource_cost_fn,4,'');?>
</span> (Parvez)-->
                    <!-- <p>Per Person USD</p> -->
                ...
                <div class="b-reservation-view-additional">
                   <!--  <span class="b-reservation-view-title">Additional Fees:</span> -->
                    ...
                    <!-- <p><?php echo $_smarty_tpl->getVariable('PackageDetailByID')->value[0]['Package_Details'];?>
</p> -->      
        ...
        <div class="b-reservation-view-additional-details">
            ...
            <p><?php echo $_smarty_tpl->getVariable('package')->value->Account_ID;?>
</p> -->
...
" required placeholder="Email: *" />
    ...
    <div class="b-brochure-input-r">
        <div class="b-brochure-input-l">
            <input type="text" required id="popup-home-phone" name="phone" value="<?php echo $_smarty_tpl->getVariable('phone')->value;?>
" placeholder="Phone: *" />
    ...
    <div class="b-popup-footer">
        <button type="submit" onclick="SalesForceLead()"></button>
        <!-- <input type="submit" name="submit" value="Confirm Availability"> -->
    </div>
