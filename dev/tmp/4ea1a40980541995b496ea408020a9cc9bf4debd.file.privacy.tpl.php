<?php /* Smarty version Smarty-3.0.8, created on 2017-12-27 15:37:43
         compiled from "/home2/talonlod/public_html/dev/app/templates/layouts/pages/frontend/privacy.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3951553295a443cd7b7e159-36590505%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ea1a40980541995b496ea408020a9cc9bf4debd' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/layouts/pages/frontend/privacy.tpl',
      1 => 1514421461,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3951553295a443cd7b7e159-36590505',
  'function' => 
  array (
  ),
...
/*.controller-frontend_gallery.action-default .b-gallery-photo h2 {
...
/*.b-gallery-wrapper h2 {
    text-align: left !important;
    margin-top: 50px !important;
    margin-bottom: 40px !important;
    color: #4a4535 !important;
...
.b-gallery-subheader {
 ...
 <div class="b-privacy-wrapper l-center cb_no_left_padding">
    ...
    <?php echo $_smarty_tpl->getVariable('page')->value->content['heading'];?>
     ...
     <?php if ($_smarty_tpl->getVariable('gallery')->value->type_id!==5){?>
 ...
 <!-- first gallery for carousel -->
            ...
            <!-- <p><?php echo smarty_modifier_debug_print_var($_smarty_tpl->getVariable('gallery')->value->type_id);?>
</p>   -->
   
     <?php }else{ ?>


        <!-- .................Started gallery section(Parvez).................... -->
        <div class="b-privacy-wrapper l-center cb_no_left_padding">
        <div class="b-privacy-l">
...
<div class="b-privacy-wrapper l-center cb_no_left_padding">
        <div class="b-privacy-l">
    <div class="b-privacy-r">

        <?php echo $_smarty_tpl->getVariable('page')->value->content['column-2'];?>

        <div class="cb_frame_wrap">
        	<div class="matterport_wrap">
             <iframe id="someFrame" src="https://my.matterport.com/show/?m=8CkM46J78iy" width="100%" height="550px"></iframe>
         </div>
         <div class="room_wrap">
             <h2>Private Rooms with Private Bathrooms</h2>
             <div class="p_room">
                 <div class="wik-25">
                    <div class="block">
            ...
            <div class="cba_room">
             <h2>Three Bedroom Accommodations</h2>
             <div class="inner_cba_room">
                <div class="wik-33-3">
                    <div class="block">
                        <div class="content_wrap">
                            <div class="img_wrap">
                ...
                <div class="wik-33-3">
                    <div class="block">
                        <div class="content_wrap">
                            ...
                            <div class="content_wrap">
                                Bluff House
                                <span>3-bedrooms/2 1/2-bathrooms</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	$(document).ready(function(){
        $(".3d_image").click(function(){
         $("#someFrame").attr("src", $(this).data("source"));
     });
    });
</script>
