<?php /* Smarty version Smarty-3.0.8, created on 2017-12-27 01:34:17
         compiled from "/home2/talonlod/public_html/dev/app/templates/frontend_reservation.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41203405159e12a8a2ff754-40841704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d0de9af57a8fe776ce574553d6c0c7810608f63' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/frontend_reservation.default.tpl',
      1 => 1507928708,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '41203405159e12a8a2ff754-40841704',
  'function' => 
  array (
    'cpf_validator' => 
    array (
...
<?php if (!is_callable('smarty_function_math')) include '/home2/talonlod/public_html/dev/cpf/libs/smarty/plugins/function.math.php';
...
<div class="b-reservation-wrapper l-center">
  <h1 class="baltica-plain">Available Package Dates</h1>
      ...
      <!-- <span><?php echo $_smarty_tpl->getVariable('Res')->value['Pms_Package_ID'];?>
</span>--<span><?php echo $_smarty_tpl->getVariable('Res')->value['Pms_Resource_ID'];?>
</span></br> -->
  <div>
    ...
    <div class="b-reservation-years clearfix" style="margin-bottom:30px;">
      ...
      <div style = "float:right; font-family:verdana; font-size:14px"><strong>
       ...
       <li id="alink"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('rule'=>'frontend_reservation'),$_smarty_tpl);?>
?yy=<?php echo $_smarty_tpl->getVariable('cyear')->value;?>
&adults=<?php echo $_smarty_tpl->getVariable('adults')->value;?>
">All Packages</li></a>
        <span id = "stand_package">Standard Packages</span>
        <li><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('rule'=>'frontend_reservation'),$_smarty_tpl);?>
?fill=bluff&adults=6">Bluff House Packages</li></a>
        </ul> --></strong>
      </div>
      <?php }?>   
      ...
      <!-- <li id="flink"><a onclick="clickbutonYear('years', '<?php echo $_smarty_tpl->getVariable('cyear')->value;?>
...
')" ><?php echo $_smarty_tpl->getVariable('cyear')->value;?>
 Packages</a></li>
      ...
      <!-- <li id="llink"><a  onclick="clickbutonYear('years', '<?php echo $_smarty_tpl->getVariable('year')->value;?>
...
')"><?php echo $_smarty_tpl->getVariable('year')->value;?>
 ...
 $_from = $_smarty_tpl->getVariable('packages')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"> -->
          <li class="<?php echo smarty_function_cycle(array('values'=>'no-bg,'),$_smarty_tpl);?>
 myli<?php if ($_smarty_tpl->getVariable('package')->value->resource_name_fn=='Bluff House'){?>185<?php }else{ ?>7<?php }?>">
...
"> -->
            <a href="reservation/<?php echo $_smarty_tpl->getVariable('package')->value->slug;?>
<?php if ($_smarty_tpl->getVariable('web')->value=='bluffhouse'){?>?web=bluffhouse&adults=<?php echo $_smarty_tpl->getVariable('adults')->value;?>
 <?php }?>">
 ...
 - <?php echo smarty_modifier_datetime_format($_smarty_tpl->getVariable('package')->value->Arrival_End_Date,"m/d/Y");?>
              ...
              <div class="b-reservation-i-r">
                   <!-- <h5>$</h5> -->
                <?php if ($_smarty_tpl->getVariable('package')->value->resource_name_fn=="Bluff House"){?>            
                <h5>Bluff House</h5>
               ...
               <!--  <p>$<?php echo $_smarty_tpl->getVariable('package')->value->Adult_Cost;?>
                ...
                <p>$<?php echo smarty_modifier_truncate($_smarty_tpl->getVariable('package')->value->resource_cost_fn,4,'');?>
</p>
                <p id = "more"><strong>More Details</strong></p>
              </div>
            </a>
