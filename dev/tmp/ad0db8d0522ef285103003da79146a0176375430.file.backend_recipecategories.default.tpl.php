<?php /* Smarty version Smarty-3.0.8, created on 2016-11-04 12:54:31
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_recipecategories.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1604203877581cf587b550b8-16469917%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad0db8d0522ef285103003da79146a0176375430' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_recipecategories.default.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
    ...
    '3b443ec398431c0d66aded6825a53024db991ce4' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/backend_recipes.submenu.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1604203877581cf587b550b8-16469917',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
Recipes<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array($_tmp1,'')), null, null);?>
    ...
    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'add')){?>
        <?php ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'add','ctype'=>$_smarty_tpl->getVariable('type')->value),$_smarty_tpl);?>
?r=<?php echo $_smarty_tpl->getVariable('cpf_url_current')->value;?>
<?php  Smarty::$_smarty_vars['capture']["add_url"]=ob_get_clean();?>
        <?php ob_start(); ?>
            <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('Add Category'),'icon'=>'plus-sign','url'=>Smarty::$_smarty_vars['capture']['add_url']));?>
	...
	<?php $_template = new Smarty_Internal_Template('backend_recipes.submenu.tpl', $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->properties['nocache_hash']  = '1604203877581cf587b550b8-16469917';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2016-11-04 12:54:31
         compiled from "/home2/talonlod/public_html/dev/app/templates/backend_recipes.submenu.tpl" */ ?>
	<ul class="nav nav-pills">
		<li role="presentation"<?php if ($_smarty_tpl->getVariable('cpf_controller')->value=='backend_recipes'){?> class="active"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_recipes'),$_smarty_tpl);?>
">Recipes</a></li>
		<li role="presentation"<?php if ($_smarty_tpl->getVariable('cpf_controller')->value=='backend_recipecategories'&&(!$_smarty_tpl->getVariable('type')->value||$_smarty_tpl->getVariable('type')->value=='meal')){?> class="active"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_recipecategories','type'=>'meal'),$_smarty_tpl);?>
">Meal Types</a></li>
		<li role="presentation"<?php if ($_smarty_tpl->getVariable('cpf_controller')->value=='backend_recipecategories'&&$_smarty_tpl->getVariable('type')->value=='fish'){?> class="active"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_recipecategories','type'=>'fish'),$_smarty_tpl);?>
">Fish Types</a></li>
		<li role="presentation"<?php if ($_smarty_tpl->getVariable('cpf_controller')->value=='backend_recipecategories'&&$_smarty_tpl->getVariable('type')->value=='technique'){?> class="active"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_recipecategories','type'=>'technique'),$_smarty_tpl);?>
">Techniques</a></li>
	</ul>
<?php $_smarty_tpl->updateParentVariables(0);?>
<?php /*  End of included template "/home2/talonlod/public_html/dev/app/templates/backend_recipes.submenu.tpl" */ ?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '1604203877581cf587b550b8-16469917';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2016-11-04 12:54:31
...
" class="table table-striped">
    ...
    <?php if (!empty($_smarty_tpl->getVariable('cpf_entities',null,true,false)->value)){?>
        ...
        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'key'));?>
...
">
        ...
        <td>
            <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights('backend_navigationelements','view')){?>
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_navigationelements','action'=>"view",'id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
        ...
        <td><?php echo $_smarty_tpl->getVariable('item')->value->key;?>
</td>
        <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
            <td>
...
backend.common.edit<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <?php }?>
                <?php if (is_null($_smarty_tpl->getVariable('item')->value->key)||$_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'delete')){?>
...
');"><i class="icon-trash"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
