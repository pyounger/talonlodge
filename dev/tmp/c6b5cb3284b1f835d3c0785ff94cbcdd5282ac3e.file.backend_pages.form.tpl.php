<?php /* Smarty version Smarty-3.0.8, created on 2015-12-11 08:40:32
         compiled from "/home2/talonlod/public_html/dev/app/templates/forms/backend_pages.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1862481735566b0a90d48ba0-19926758%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6b5cb3284b1f835d3c0785ff94cbcdd5282ac3e' => 
    array (
      0 => '/home2/talonlod/public_html/dev/app/templates/forms/backend_pages.form.tpl',
      1 => 1446588287,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1862481735566b0a90d48ba0-19926758',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.pages.editing_page<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }else{ ?>
		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.pages.adding_page<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.pages.pages'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
...
$_template->properties['nocache_hash']  = '1862481735566b0a90d48ba0-19926758';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2015-12-11 08:40:33
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
    ...
    <?php if (!$_smarty_tpl->getVariable('cpf_is_edit')->value){?>
        <?php $_smarty_tpl->tpl_vars['seo_robots'] = new Smarty_variable('index, follow', null, null);?>
    <?php }?>
...
tables.pages.<?php echo $_smarty_tpl->getVariable('field')->value;?>
...
"<?php if ($_smarty_tpl->getVariable('page')->value->data->id==$_smarty_tpl->getVariable('parent_id')->value){?> selected="selected"<?php }?><?php if ($_smarty_tpl->getVariable('page')->value->data->id==$_smarty_tpl->getVariable('id')->value){?> disabled="disabled"<?php }?>>
...
?>—<?php endfor; endif; ?> <?php }?><?php echo $_smarty_tpl->getVariable('page')->value->data->title;?>
    ...
    <?php $_smarty_tpl->tpl_vars['field'] = new Smarty_variable('type', null, null);?>
    <div class="control-group">
        <label for="<?php echo $_smarty_tpl->getVariable('field')->value;?>
" class="control-label"><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
tables.pages.<?php echo $_smarty_tpl->getVariable('field')->value;?>
...
" class="field <?php echo $_smarty_tpl->getVariable('class')->value;?>
">
                <?php  $_smarty_tpl->tpl_vars['cptype'] = new Smarty_Variable;
 $_from = cpf_config('APP.CONTENT.PAGE_TYPES'); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['cptype']->key => $_smarty_tpl->tpl_vars['cptype']->value){
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['cptype']->value;?>
"<?php if ($_smarty_tpl->getVariable('type')->value==$_smarty_tpl->tpl_vars['cptype']->value){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['cptype']->value;?>
</option>
                <?php }} ?>
            </select>
        </div>
    </div>
    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"slug",'field'=>"slug",'title_field'=>'title','wr_class'=>"for-content"));?>

    <?php $_smarty_tpl->tpl_vars['field'] = new Smarty_variable('component', null, null);?>
...
" class="field <?php echo $_smarty_tpl->getVariable('class')->value;?>
">
                <?php  $_smarty_tpl->tpl_vars['cvalue'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['ckey'] = new Smarty_Variable;
 $_from = cpf_config('APP.CONTENT.COMPONENTS'); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['cvalue']->key => $_smarty_tpl->tpl_vars['cvalue']->value){
 $_smarty_tpl->tpl_vars['ckey']->value = $_smarty_tpl->tpl_vars['cvalue']->key;
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['ckey']->value;?>
"<?php if ($_smarty_tpl->getVariable('component')->value==$_smarty_tpl->tpl_vars['ckey']->value){?> selected="selected"<?php }?>><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.components.<?php echo $_smarty_tpl->tpl_vars['ckey']->value;?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</option>
                <?php }} ?>
            </select>
    ...
    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"select",'field'=>"layout_id",'list'=>$_smarty_tpl->getVariable('layouts')->value));?>

	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"checkbox",'field'=>"is_published"));?>

	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"hidden",'field'=>"is_template"));?>

    </fieldset>
    <fiedlset>
        <legend><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.pages.seo<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</legend>
        <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"seo_title"));?>

        <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"seo_robots"));?>

        <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"textarea",'field'=>"seo_keywords"));?>

        <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"textarea",'field'=>"seo_description"));?>
