...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Fishing Group Report <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Fishing Group Report: </b> You can Manage Fishing Group Report here </p>
        </blockquote>
    </div>
</div>
...
<!--                                                <td class="visible-xs visible-sm visible-md visible-lg"><img src="files/contents/<?php print($row->cont_image); ?>" width="250" style="width: 250px;" /></td>-->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Manage Fishing Group Report
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
...
<!--                                            <tr>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    ...
                                                    <?php
                                                        ...
                                                        SELECT
                                                        p.Pms_Package_ID, p.Package_Name, p.Arrival_Start_Date, p.Arrival_End_Date, p.Package_Max_Days,
                                                        g.grp_id, g.GroupName, g.GroupArrivalDate, g.GroupDepartureDate, c.ContactID, c.ContactFirstName, 
														c.ContactLastName, c.cont_image, cp.conp_id, cp.bootsize_id, j.jacketsize_name
                                                        FROM packages AS p 
                                                        ...
                                                        LEFT OUTER JOIN jacket_size AS j ON cp.jacketsize_id=j.jacketsize_id
                                                        WHERE p.Pms_Package_ID = ".$row->Pms_Package_ID." AND p.Arrival_Start_Date > '2014-05-01' AND p.Arrival_Start_Date = g.GroupArrivalDate AND p.Arrival_End_Date = g.GroupDepartureDate
                                                        GROUP BY g.grp_id 
                                                                ...
                                                                echo '<tr>';
                                                                    echo '<th>';
                                                                        echo '<th class="visible-xs visible-sm visible-md visible-lg">';
                                                                            echo $row11->GroupName." - <a href=manage_fishing_group_report_print.php?pms_pak_id=".$row->Pms_Package_ID."&grp_id=".$row11->grp_id." target='_blank'>Report</a>";
