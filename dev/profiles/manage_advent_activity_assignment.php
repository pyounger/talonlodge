                                                            ...
                                                            if ($no_of_days == $day_counter) {
                                                                ...
                                                                if ($no_of_days != (1 + $day_counter)) {
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        Start Time: <br/> 
                                                                        <input type="text" name="asch_start_time[]" value="<?php echo calendarTimeConver1($row99->asch_start_date);?>" style="width:200px;">
                                                                        <p> Time Format: 24 Hour System </p>
                                                                        
                                                                        End Time: <br/> 
                                                                        <input type="text" name="asch_end_time[]" value="<?php echo calendarTimeConver1($row99->asch_end_date);?>" style="width:200px;">
                                                                        <p> Time Format: 24 Hour System </p>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        Start Time: <br/> 
                                                                        <input type="text" name="asch_start_time[]" value="00:00:00" style="width:200px;">
                                                                        <p> Time Format: 24 Hour System </p>
                                                                        
                                                                        End Time: <br/> 
                                                                        <input type="text" name="asch_end_time[]" value="00:00:00" style="width:200px;">
                                                                        <p> Time Format: 24 Hour System </p>
