		...
		<div class="<?php print($class);?>"><?php print($strMSG);?></div>
				...
				?>
						...
						<div class="col-lg-10 col-md-9">
									...
									<input type="text" class="form-control form-cascade-control input_wid70 datetimepicker" placeholder="Arrival Flight Date..." value="<?php $ar_dat1 = (($arrival_flight_data=='00/00/0000')?'':$arrival_flight_data); $ar_dat2 = @calendarDateConver2(@returnName(" g.GroupArrivalDate ", " groups AS g ", " g.grp_id ", $_SESSION['group_id'])); echo (($ar_dat1!='')?$ar_dat1:$ar_dat2);?>" id="arrival_flight_data" name="arrival_flight_data">
								</div>
					</div>
							<div class="form-group">
						...
						<div class="col-lg-10 col-md-9">
									...
									<input type="text" class="form-control form-cascade-control input_wid70  datetimepicker" placeholder="Departure Flight Date..." value="<?php $dr_dat1 = (($departure_flight_date=='00/00/0000')?'':$departure_flight_date); $dr_dat2 = @calendarDateConver2(@returnName(" g.GroupDepartureDate ", " groups AS g ", " g.grp_id ", $_SESSION['group_id'])); echo (($dr_dat1!='')?$dr_dat1:$dr_dat2);?>" id="departure_flight_date" name="departure_flight_date">
								</div>
					</div>
							<div class="form-group">
    ...
    if (mysql_num_rows($rs) > 0) {
        while ($row = mysql_fetch_object($rs)) {
            ...
            ?>
								...
								<td class="visible-sm visible-md visible-lg"><?php echo (($row->arrival_date=='0000-00-00 00:00:00')?'':calendarDateConver2($row->arrival_date));?></td>
								<td class="visible-sm visible-md visible-lg"><?php echo (($row->departure_date=='0000-00-00 00:00:00')?'':calendarDateConver2($row->departure_date));?></td>
