...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Bar Items Report <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Bar Items Report: </b> You can Manage Bar Items Report here </p>
        </blockquote>
    </div>
</div>
...
ORDER BY c.ContactFirstName ASC";*/
                                        ...
                                        if (mysql_num_rows($rs) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="bitem_id[]" id="bitem_id[]" data-placeholder="Choose an Item..." class="chosen-select required" style="width:240px; z-index: 9999 !important;" tabindex="2">
                                                        <option value=""></option>
                                                        <?php echo FillSelected("bar_items WHERE bitem_type=1 ", "bitem_id", "bitem_name", @$bvo_id) ?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <input type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Quantity" value="1" name="bord_quatity[]" size="2" maxlength="2">
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Manage Bar Items Report
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
        ...
        if (mysql_num_rows($rs) > 0) {
            while ($row = mysql_fetch_object($rs)) {
                ...
                ?>
                                            <tr>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <a href="manage_bar_item_report_print.php?pms_pak_id=<?php echo $row->Pms_Package_ID;?>" target="_blank">
