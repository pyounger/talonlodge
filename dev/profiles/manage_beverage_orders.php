...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Beverage Orders <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Beverage Orders: </b> You can manage your Beverage Orders here </p>
        </blockquote>
    </div>
</div>
...
AND acts.grp_id=".$row->grp_id." ";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Beverage Orders 
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
