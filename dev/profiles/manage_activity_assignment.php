...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Boat and Activity Assignment <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b> Boat and Activity Assignment : </b> You can  Boat and Activity Assignment  here </p>
        </blockquote>
    </div>
</div>
...
//            echo '</pre>';
            for ($i = 0; $i < count($_REQUEST['act_boat_id']); $i++) {
                ...
                if($arr[0] != 0){
//                    echo $act_boat_id = $arr[0];
//                    echo '<br/>';
//                    echo $asch_start_date = $arr[1];
//                    echo '<br/>';
//                    echo $cont_id = $arr[2];
//                    echo '<br/>';
//                    echo $grp_id = $arr[3];
       ...
       ?>
                                                        ...
                                                        if ($day_counter != 1) {
                                                            if ($no_of_days == $day_counter) {
                                                                ...
                                                                if ($no_of_days != (1 + $day_counter)) {
                                                                    $day_counter1++;
                                                                    //echo '<br>2 '.$dt->format("m/d/Y");
                                                                    echo '<td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 100px;">';
                                                                    $Query99 = "
                                                                    SELECT 
                                                                    asch.asch_id, asch.act_id, asch.asch_start_date, acn.act_name, actb.act_boat_name
                                                                    FROM  
                                                                    ...
                                                                    if ($count99 > 0) {
                                                                        while ($row99 = mysql_fetch_object($rs99)) {
                                                                            echo $row99->act_name.'<br/>'.$row99->act_boat_name.'<br/>';
                                                                            ?>
                                                                                <select name="act_id[]" style="width:0px !important; height:0px !important; visibility: hidden;">
                                                                                    <?php
                                                                                        echo "<option value=".'0,'.$dt->format("Y-m-d").','.$row->ContactID.','.$row->grp_id." selected>".$rowv[1]."</option>";
                                                                                    ?>
                                                                                </select>
                                                                                <select name="act_boat_id[]" style="width:0px !important; height:0px !important; visibility: hidden;">
                                                                                    <?php
                                                                                        echo "<option value=".'0,'.$dt->format("Y-m-d").','.$row->ContactID.','.$row->grp_id." selected>".$rowv[1]."</option>";
                                                                                    ?>
                                                                                </select>
                                                                    ...
                                                                    ?>
                                                                        <br/>
                                                                        ACTY : 
                                                                        <select name="act_id[]" data-placeholder="Choose an Activity..." class="chosen-" style="width:100px; z-index: 9999 !important;" tabindex="2">
                                                                            <?php
                                                                                $strQueryv = "SELECT act_id, act_name FROM activities WHERE status_id = 1 AND act_id IN (2,7,11) ORDER BY act_name";
                                                                                $nResultv = mysql_query($strQueryv);
                                                                                if (mysql_num_rows($nResultv) >= 1) {
                                                                                    while ($rowv = mysql_fetch_row($nResultv)) {
                                                                                        if ($rowv[0] == $row->ContactID) {
                                                                                            echo "<option value=".$rowv[0].','.$dt->format("Y-m-d").','.$row->ContactID.','.$row->grp_id." selected>".$rowv[1]."</option>";
                                                                                        } else {
                                                                                            echo "<option value=".$rowv[0].','.$dt->format("Y-m-d").','.$row->ContactID.','.$row->grp_id.">".$rowv[1]."</option>";
                                                                                        }
                                                                                    }
                                                                                }
                                                                            ?>
                                                                        ...
                                                                        <br/><br/>
                                                                        BOAT: 
                                                                        <select name="act_boat_id[]" id="act_boat_id[]" data-placeholder="Choose a Boat..." class="chosen-" style="width:100px; z-index: 9999 !important;" tabindex="2">
                                                                            <?php
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i>  Boat and Activity Assignment 
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
