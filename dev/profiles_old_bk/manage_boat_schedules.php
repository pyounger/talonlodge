...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Boat Schedules <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Boat Schedules: </b> You can manage your Boat schedules here </p>
        </blockquote>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-cascade">
                <div class="panel-heading text-primary">
                    <h3 class="panel-title"><i class="fa fa-check"></i> Manage Boat Schedules</h3>
                </div>
                <div class="panel-body ">
                    <div class="ro">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <select name="act_id" data-placeholder="Choose an Activity..." class="chosen-select" style="width:240px; z-index: 9999 !important;" tabindex="2"  onChange="javascript:document.getElementById('frm11').submit()">
                                            ...
                                            <?php echo FillSelected(" activities WHERE status_id = 1 AND act_id IN (2,7,11) ", "act_id", "act_name", @$_REQUEST['act_id']);?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
