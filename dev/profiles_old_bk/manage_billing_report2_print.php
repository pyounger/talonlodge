    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php
                ...
                $Query1 = "
                SELECT 
                acts.*, ab.act_boat_name,  abc.actboca_name, abd.actbodh_name,  c.ContactFirstName, c.ContactLastName, cp.conp_id, ac.act_name, ag.ag_name, av.av_name, g.GroupName, actt.ath_name, acttt.atht_name
                FROM 
            ...
            ?>
                        ...
                        <div style="padding-left: 100px;">
                            <?php echo '<br/>'.calendarDateConver2($row1->asch_start_date).'<br/>'.date('H:i:s', strtotime($row1->asch_start_date)).', '.date('H:i:s', strtotime($row1->asch_end_date)).', '.$row1->asch_duration.' Minutes';?>
                            <?php if($row1->act_boat_id!='' && $row1->act_boat_id!=0){?>
                                <?php echo '<br/>'.$row1->act_boat_name.', '.$row1->ath_name.', '.$row1->atht_name;?>
                            <?php } else {?>
                                <?php echo '<br/>'.$row1->act_name.', '.$row1->ath_name.', '.$row1->atht_name;?>
                            <?php }?>
                            <?php
                                $confirmation = '';
                                $Query2 = "
