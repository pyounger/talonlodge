...
if (isset($_REQUEST['Booking_Status'])) {
    $_SESSION['Booking_Status'] = $_REQUEST['Booking_Status'];
} else {
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Unconfirmed Group<?php echo (($_SESSION["UType"]==1)?'s':'');?> <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="">
            <strong>NOTE:</strong>
            <p> Group status may be 'Confirmed' but their Arrival and Departure dates are empty. </p>
        </blockquote>
                ...
                <div class="panel-body panel-border">
                    <form name="frm" id="frm" method="post" class="form-horizontal" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="Choose a Group..." class="chosen-select" style="width:260px; z-index: 9999 !important;" tabindex="2" name="Booking_Status" id="Booking_Status" tabindex="2">
                                    <option value="Confirmed" <?php echo ((isset($Booking_Status)&&$Booking_Status=='Confirmed')?"selected='selected'":'');?>>Confirmed</option>
                                    <option value="Pending" <?php echo ((isset($Booking_Status)&&$Booking_Status=='Pending')?"selected='selected'":'');?>>Pending</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="Choose a Group..." class="chosen-select" style="width:260px; z-index: 9999 !important;" tabindex="2" name="Contact_ID" id="Contact_ID" tabindex="2">
                                    <option value=""></option>
...
<?php } elseif ((isset($_REQUEST['show']))&&($_REQUEST['show']==1)) { ?>
    ...
    <?php print($Package_Name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-9 det-display">
    <?php print($ContactFirstName.' '.$ContactLastName); ?>
                                <!--<input type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Customer name..." value="<?php //print($grp_name);  ?>" id="grp_name" name="grp_name" readonly>-->
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-heading text-primary">
                    <h3 class="panel-title"><i class="fa fa-th-large"></i> Guests in <?php echo returnName("GroupName", "groups", "grp_id", $_REQUEST['grp_id']);?>
        ...
        while ($row = mysql_fetch_object($rs)) {
            ...
            ?>
                        <tr>
                            ...
                            <td class="visible-lg"><?php print($row->ContactFirstName);?> </td>
                            <td class="visible-lg"><?php print($row->ContactLastName);?></td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-cascade">
                        ...
                        <div class="panel-heading text-primary">
                            <?php if($_SESSION["UType"]==1){?>
                                <h3 class="panel-title"><i class="fa fa-th-large"></i> Unconfirmed Groups
<!--                                    <span class="pull-right" style="width:auto;">
                            ...
                            <div class="ro">
                                <div class="col-mol-md-offset-2">
                                    <form name="frm21" id="frm21" method="post" class="form-horizontal cascde-forms" action="<?php print($_SERVER['PHP_SELF']); ?>">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-3 control-label">Select Status:</label>
                                            <div class="col-lg-10 col-md-9">
                                                <select name="Booking_Status" data-placeholder="Choose a Status..." class="chosen-select" style="width:240px; z-index: 9999 !important;" tabindex="2"  onChange="javascript:document.getElementById('frm21').submit()">
                                                    <option value="Confirmed" <?php echo ((isset($_SESSION['Booking_Status'])&&$_SESSION['Booking_Status']=='Confirmed')?"selected='selected'":'');?>>Confirmed</option>
                                                    <option value="Hold" <?php echo ((isset($_SESSION['Booking_Status'])&&$_SESSION['Booking_Status']=='Hold')?"selected='selected'":'');?>>Hold</option>
                                                    <option value="" <?php echo ((isset($_SESSION['Booking_Status'])&&$_SESSION['Booking_Status']=='')?"selected='selected'":'');?>>Deleted</option>
                                                </select>
                                            </div>
                                        </div>
                                    </form>    
    ...
    <?php
                    ...
                    $Query = "SELECT g.grp_id, g.Contact_ID, g.Pms_Booking_ID, g.GroupName, g.GroupArrivalDate, g.GroupDepartureDate, g.Booking_Status, g.grp_total_cust, c.ContactFirstName, c.ContactLastName, p.Package_Name FROM groups AS g  LEFT OUTER JOIN contacts AS c ON g.Contact_ID=c.ContactID LEFT  OUTER JOIN packages AS p ON g.Pms_Package_ID=p.Pms_Package_ID WHERE (g.GroupArrivalDate='0000-00-00' OR g.GroupDepartureDate='0000-00-00') AND (g.Booking_Status='".$_SESSION['Booking_Status']."') ORDER BY g.GroupName";
        ...
        while ($row = mysql_fetch_object($rs)) {
            ...
            ?>
                                        <tr>
                                            ...
                                            <td class="visible-sm visible-md visible-lg"><?php print($row->Booking_Status); ?></td>
