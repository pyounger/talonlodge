...
if(isset($_REQUEST['action'])){
	if(isset($_REQUEST['btnAdd'])){
		...
		mysql_query("INSERT INTO bar_items(bitem_id,bitem_name,bitem_details, bitem_type) VALUES(".$barid.",'".$_REQUEST['bitem_name']."', '".$_REQUEST['bitem_details']."', '1')") or die(mysql_error());
						...
						<div class="panel-body panel-border">
                        	<form name="frm" id="frm" method="post" class="form-horizontal" action="<?php print($_SERVER['PHP_SELF']."?".$_SERVER['QUERY_STRING']);?>" role="form">
                          	  <div class="form-group">
                              	<label for="site_login" class="col-lg-2 col-md-3 control-label">Bar Item Name</label>
                                <div class="col-lg-10 col-md-9">
                            	<input type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Bar Item Name..." value="<?php print($bitem_name);?>" id="act_name" name="bitem_name">
                                </div>
                             </div>
                             <div class="form-group">
                              	<label for="site_login" class="col-lg-2 col-md-3 control-label">Bar Item Details</label>
                                <div class="col-lg-10 col-md-9">
                            	<textarea type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Bar Item Details.."  id="bitem_details" name="bitem_details"><?php print($bitem_details);?></textarea>
                                </div>
                             </div>
				 ...
				 <div class="<?php print($class);?>"><?php print($strMSG);?></div>
					<div class="panel">
						<div class="panel-heading text-primary">
							<h3 class="panel-title"><i class="fa fa-glass"></i> Bar Items 
							...
							<table class="table users-table table-condensed table-hover table-striped display dataTable" id="example" >
								...
								<?php
									if($_SESSION['user_id']>0){
										...
										$Query="SELECT * FROM bar_items WHERE bitem_type=1";
									}
									$counter=0;
									$limit = 25;
								...
								?>
									<tr>
                                                                            ...
                                                                            <td style="width:135px">
                                                                                <div class="tooltips"><a href="manage_bar_items.php?act_id=<?php print($row->bitem_id);?>&btnDelete=1&chkstatus=<?php print($row->bitem_id);?>" data-original-title="Delete Record" data-placement="top" class="btn bg-primary text-white" style="float:left; margin-left: 2px; margin-bottom: 2px;"><i class="fa fa-minus-circle"></i></a></div>
