...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Housekeeping Report <?php if(isset($_REQUEST['pms_pak_id'])){?> - <a href="manage_housekeeping_report_print.php?show=1&pms_pak_id=<?php echo $_REQUEST['pms_pak_id'];?>">Go to Printing Page</a><?php }?> <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b> Housekeeping Report: </b> You can see Housekeeping Report here </p>
        </blockquote>
    </div>
</div>
...
//                                                    }
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-list"></i> Housekeeping Report
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
