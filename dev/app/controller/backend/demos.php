...
class App_Controller_Backend_Demos extends App_Controller_Base_BackendSmart

{



	protected $model = 'App_Model_Demo';
...

	{
		...
		$this->attachment_path = $this->config->value('APP.DEMO.PATH');

		$this->attachment_url = $this->config->value('APP.DEMO.URL');
		...
		$this->attach_fields = array(
			...
			array(
				...
				'name' => 'private_bedroom_image',

				'attach_field_delete' => 'delete_private_bedroom_image',
			...
			array(
				...
				'name' => 'three_bedroom_image',

				'attach_field_delete' => 'delete_three_bedroom_image',
			...
			array(
				...
				'name' => 'private_bedroom_small_image',

				'attach_field_delete' => 'delete_private_bedroom_small_image',
			...
			array(
				...
				'name' => 'three_bedroom_small_image',

				'attach_field_delete' => 'delete_three_bedroom_small_image',
...
class App_Controller_Backend_Demos_Form_Helper extends App_Local_Form_Helper

{
...

	{
		...
		$attach_fields = array('main_image', 'private_bedroom_image', 'three_bedroom_image');
...

		{
...

			{
...

				{
...

					{
						...
						if (!in_array($file['type'], $this->config->value('APP.DEMOS.TYPES')))

						{

							$this->errors[] = t('backend.demos.upload_correct_file');
...

					{
						...
						$this->errors[] = sprintf('%s: %s', t('backend.demos.upload_error'), $file['error']);
...

			{
				...
				$this->errors[] = t('backend.demos.required_filename');
