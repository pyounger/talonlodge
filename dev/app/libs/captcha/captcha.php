...
$font_size_min=33; /* минимальная высота символа */
$font_size_max=33; /* максимальная высота символа */
$font_file="app/libs/captcha/fonts/lsans.ttf"; /* путь к файлу относительно w3captcha.php */
$char_angle_min=-10; /* максимальный наклон символа влево */
$char_angle_max=10;	/* максимальный наклон символа вправо */
$char_angle_shadow=10;	/* размер тени */
$char_align=35;	/* выравнивание символа по-вертикали */
...
$font_color=imagecolorallocate($image, 163, 132, 127); /* rbg-цвет тени */
