...
$CPF_CONFIG['URL']['ROUTES']['REGEXP'] = array(
    ...
    'frontend_reservations' => array(

        'rule' => 'reservations\/(.*)',

        'controller' => 'frontend_reservations',
    ...
    'frontend_bluffhouse_update' => array(
    ...
    'frontend_bluffhouse_view' => array(
    ...
    'frontend_testings_view' => array(

        'rule' => 'testing\-finder\/(?P<id>[0-9]*?)\-(?P<slug>[a-zA-Z0-9\/\-_]*?)\/(.+)?',

        'controller' => 'frontend_testings',

        'action' => 'view',

        'reverse' => 'testing-finder/%d-%s/'

        ),

    'frontend_testings' => array(

        'rule' => 'testing\-finder\/(.*)',

        'controller' => 'frontend_testings',

        'reverse' => 'testing-finder/'
