...
<!--      <div>
    ...
    <div class="btns">
       <!--  <a id = "preve" href = "http://www.dev.talonlodge.com/reservation/{if $web == 'bluffhouse'}?&adults={$adults}&web=bluffhouse{/if}">Previous Page</a> -->

        <a id = "preve" href = "http://www.dev.talonlodge.com/reservation/?start={$start}&end={$end}&adults={$sessadults}">Previous Page</a>
    ...
    <div class="b-reservation-view-container">
        <div class="b-reservation-view-column">
            <div class="b-reservation-subcolumn">
                <div class="b-reservation-view-r">
                    <div class="b-reservation-view-l">
                       ...
                       <!--  <span>
                        ...
                        <!-- <span>
                            Minimum Group Size {$package->Package_Min_Adults}
                        </span> Remove for new doc(Parvez)--></br>
                      <!--   <span> {$Resource_Name} ---{$Resource_id}</span> -->
                        <!-- <span> {$Resource_Name} </span> -->
                         <span>{*if $package->resource_name_fn == "Bluff House"*}
                                <!-- The Bluff House -->
                                {*else*}
                                {*$Resource_Name*}
                                {*$package->resource_name_fn*} <!-- Remove for new doc(Parvez) -->
                                {*/if*}
                           </span>
                ...
                <!-- <pre>
                {$PackageDetailByID|@debug_print_var}</pre> -->
            ...
            <span>Prices Range from:</span>
                <div class="b-reservation-view-price">
                    ...
                    <span>${$LowestRate|truncate:4:""} to ${$HighestRate|truncate:4:""}</span>
                     <!-- <span>${$package->resource_cost_fn|truncate:4:""}</span> (Parvez)-->
                    <!-- <p>Per Person USD</p> -->
                ...
                <div class="b-reservation-view-additional">
                   <!--  <span class="b-reservation-view-title">Additional Fees:</span> -->
                    ...
                    <!-- <p>{$PackageDetailByID[0].Package_Details}</p> -->      
                    <p>{$Package_Details}</p>           
                </div>
            </div>
        </div>
...
<div id="confirm" style="display: none">
    ...
    <div class="b-brochure-input-r">
        <div class="b-brochure-input-l">
            <input type="text" required id="popup-home-phone" name="phone" value="{$phone}" placeholder="Phone: *" />
