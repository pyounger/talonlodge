...
{block name='title'}
    {capture name='site_title'}{t}Contact Us Messages{/t}{/capture}
		...
		<tr>
			<td>
				<div style="padding: 0 20px 0 0;">
					<a href="{link controller=$cpf_controller action='export'}" class="btn btn-success">CSV Export</a>
				</div>
			</td>
		</tr>
	</table>
...
{block name='content'}
    ...
    <tr class="{cycle values=',alternate'}">
        ...
        <td style="width: 20%;" class="span1"><a href="mailto:{$item->email}">{$item->email}</a></td>
