...
{block name='title'}
{if $cpf_is_edit}
{capture name='page_title'}{t}backend.demo.editing_demo{/t}{/capture}
{else}
{capture name='page_title'}{t}backend.demo.adding_demo{/t}{/capture}
{/if}
...
{$cpf_breadcrumb=[
	[t('backend.demo.demo'), cpf_link(['controller' => $cpf_controller])],
	[$smarty.capture.page_title]
	]}
...
messages: {
title: { required: '{t}backend.demo.required_title{/t}' },
description: { ck_not_empty: '{t}backend.demo.required_description{/t}' },
one_bedroom_description: { ck_not_empty: '{t}backend.demo.required_one_bedroom_description{/t}' },
two_bedroom_description: { ck_not_empty: '{t}backend.demo.required_two_bedroom_description{/t}'},
{if !$cpf_is_edit}
main_image: { required: '{t}backend.demo.required_main_image{/t}'},
one_bedroom_image: { required: '{t}backend.demo.required_one_bedroom_image{/t}'},
two_bedroom_image: { required: '{t}backend.demo.required_two_bedroom_image{/t}'},
{/if}
one_bedroom_popup_description: { ck_not_empty: '{t}backend.demo.required_one_bedroom_popup_description{/t}'},
two_bedroom_popup_description: { ck_not_empty: '{t}backend.demo.required_two_bedroom_popup_description{/t}'}
}
{/capture}
...
<div class="control-group">
	<label class="control-label" for="main_image">{t}tables.demo.main_image{/t}:</label>
	<div class="controls">
...
<table>
	<tbody>
		...
		<tr>
			<td>
				<div class="control-group">
					<label class="control-label" for="one_bedroom_image">{t}tables.demo.one_bedroom_image{/t}:</label>
					<div class="controls">
			...
			<td style="padding: 0 0 0 20px;">
				<div class="control-group">
					<label class="control-label" for="two_bedroom_image">{t}tables.demo.two_bedroom_image{/t}:</label>
					<div class="controls">
		...
		<tr>
			<td>
				<div class="control-group">
					<label class="control-label" for="one_bedroom_small_image">{t}tables.demo.one_bedroom_small_image{/t}:</label>
					<div class="controls">
			...
			<td style="padding: 0 0 0 20px;">
				<div class="control-group">
					<label class="control-label" for="two_bedroom_small_image">{t}tables.demo.two_bedroom_small_image{/t}:</label>
					<div class="controls">
