...
{block name='title'}
	{if $cpf_is_edit}
		{capture name='page_title'}{t}backend.reviews.editing_review{/t}{/capture}
	{else}
		{capture name='page_title'}{t}backend.banners.adding_review{/t}{/capture}
	{/if}
...
{block name='content_init'}
    ...
    {capture name='validation_rules'}
        ...
        messages: {
            title: { required: '{t}backend.reviews.required_title{/t}' },
            key: { required: '{t}backend.reviews.required_key{/t}' },
            content: { ck_not_empty: '{t}backend.reviews.required_content{/t}' }
        }
    {/capture}
