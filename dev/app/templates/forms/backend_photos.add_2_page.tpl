...
{block name='content'}
    <div class="container">
        ...
        <form id="fileupload" action="{link controller=$cpf_controller action='upload_2_page' id=$page->id page_placeholder=$page_placeholder}" method="POST" enctype="multipart/form-data">
