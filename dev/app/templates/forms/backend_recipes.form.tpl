...
{block name='title'}
	{if $cpf_is_edit}
		{capture name='page_title'}{t}Edit Recipe{/t}{/capture}
	{else}
		{capture name='page_title'}{t}New Recipe{/t}{/capture}
	{/if}
...
{block name='content_init'}
	...
	{$cpf_breadcrumb=[
		[t('Recipes'), cpf_link(['controller' => $cpf_controller])],
		[$smarty.capture.page_title]
	]}
...
{block name='content'}
	...
	{cpf_input type="multiple_select" field="meal_type" list=$meal_types value=$categories_values label=t('tables.recipes.meal_type')}
	{cpf_input type="multiple_select" field="fish_type" list=$fish_types value=$categories_values label=t('tables.recipes.fish_type')}
	{cpf_input type="multiple_select" field="technique_type" list=$technique_types value=$categories_values label=t('tables.recipes.technique_type')}
