...
if (isset($_REQUEST['action'])) {
    if (isset($_REQUEST['btnAdd'])) {
        ...
        mysql_query("INSERT INTO bar_items(bitem_id, bitem_name, bitem_details, bitem_type) VALUES(" . $barid . ",'" . $_REQUEST['bitem_name'] . "', '" . $_REQUEST['bitem_details'] . "', '3')") or die(mysql_error());
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Menu Items <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Menu Items: </b> You can manage your Menu Items here </p>
        </blockquote>
    </div>
</div>
                ...
                <div class="panel-body panel-border">
                    <form name="frm" id="frm" method="post" class="form-horizontal" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>" role="form">
                        <div class="form-group">
                            <label for="site_login" class="col-lg-2 col-md-3 control-label">Menu Item Name</label>
                            <div class="col-lg-10 col-md-9">
                                <input type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Menu Item Name..." value="<?php print($bitem_name); ?>" id="act_name" name="bitem_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="site_login" class="col-lg-2 col-md-3 control-label">Menu Item Details</label>
                            <div class="col-lg-10 col-md-9">
                                <textarea type="text" class="form-control form-cascade-control input_wid70 required" placeholder="Menu Item Details.."  id="bitem_details" name="bitem_details"><?php print($bitem_details); ?></textarea>
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-heading text-primary">
                    <h3 class="panel-title"><i class="fa fa-glass"></i> Menu Items 
            ...
            ?>
                                        <tr>
                                            ...
                                            <td style="width:135px">
                                                <div class="tooltips"><a href="manage_menu_items.php?act_id=<?php print($row->bitem_id); ?>&btnDelete=1&chkstatus=<?php print($row->bitem_id); ?>" data-original-title="Delete Record" data-placement="top" class="btn bg-primary text-white" style="float:left; margin-left: 2px; margin-bottom: 2px;"><i class="fa fa-minus-circle"></i></a></div>
