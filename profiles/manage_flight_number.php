...
if(isset($_REQUEST['action'])){
    if(isset($_REQUEST['btnAdd'])){
		...
		mysql_query("INSERT INTO flight_no(flightn_id, flightn_name, flightn_status, flightt_id, flight_id) VALUES (".$actid.",'".dbStr($_REQUEST['flightn_name'])."','".dbStr($_SESSION['flightn_status'])."','".dbStr($_REQUEST['flightt_id'])."','".dbStr($_REQUEST['flight_id'])."')") or die(mysql_error());
		header("Location: ".$_SERVER['PHP_SELF']."?op=1");
    }
    elseif(isset($_REQUEST['btnUpdate'])){
		$udtQuery = "UPDATE flight_no SET flightn_name='".dbStr($_REQUEST['flightn_name'])."', flightt_id='".dbStr($_REQUEST['flightt_id'])."', flight_id='".dbStr($_REQUEST['flight_id'])."' WHERE flightn_id=".$_REQUEST['flightn_id'];
...
<?php include('includes/html_header.php');?>
				...
				<div class="col-md-12">
						...
						<div class="panel-body panel-border">
								...
								<div class="form-group">
									<label for="site_login" class="col-lg-2 col-md-3 control-label">Flight Name</label>
									<div class="col-lg-10 col-md-9">
										<select name="flight_id" id="flight_id" data-placeholder="Choose a Flight..." class="chosen-select" style="width:240px; z-index: 9999 !important;" tabindex="2">
											<?php echo FillSelected("flight_info WHERE flight_is_airline=1", "flight_id", "flight_name", @$flight_id);?>
										</select>
									</div>
								</div>
								<div class="form-group">
				...
				<div class="col-md-12">
						...
						<div class="panel-heading text-primary">
									...
									<h3 class="panel-title"><i class="fa fa-sort-numeric-asc"></i> Flight Numbers <span class="pull-right" style="width:auto;">
				...
				<div class="col-md-12">
						...
						<div class="panel-body">
								...
								<table class="table users-table table-condensed table-hover table-striped display dataTable" id="example" >
											<thead>
										<tr>
													<th class="visible-xs visible-sm visible-md visible-lg">Flight Name</th>
											...
											<tbody>
								<?php
                                    $Query="SELECT fn.*, ft.flightt_name, fi.flight_name FROM flight_no AS fn LEFT OUTER JOIN flight_time AS ft ON fn.flightt_id=ft.flightt_id LEFT OUTER JOIN flight_info AS fi ON fi.flight_id=fn.flight_id  WHERE fn.flightn_status=".$_SESSION['flightn_status']."";
									$counter=0;
									$limit = 25;
								...
								?>
										<tr>
												<td class="visible-xs visible-sm visible-md visible-lg"><?php print($row->flight_name);?></td>
												...
												<td style="width:135px"><div class="tooltips"><a href="manage_flight_number.php?flightn_id=<?php print($row->flightn_id);?>&btnDelete=1&chkstatus=<?php print($row->flightn_id);?>" data-original-title="Delete Record" data-placement="top" class="btn bg-primary text-white" style="float:left; margin-left: 2px; margin-bottom: 2px;"><i class="fa fa-minus-circle"></i></a></div>
												...
												<div class="tooltips"><a href="<?php print($_SERVER['PHP_SELF']."?action=2&flightn_id=".$row->flightn_id);?>" data-original-title="Update Record" data-placement="top" class="btn bg-primary text-white" style="float:left; margin-left: 2px; margin-bottom: 2px;"><i class="fa fa-edit"></i></a></div></td>
												</tr>
										<?php
										}
									}
