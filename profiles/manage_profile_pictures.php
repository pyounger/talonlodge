...
if (isset($_REQUEST['grp_id'])) {
    ...
    if (isset($_REQUEST['btnUpdate'])) {
        ...
        $udtQuery = "UPDATE contacts SET cont_image = '" . $pic . "' WHERE ContactID = " . $_REQUEST['contactid']; 
        mysql_query($udtQuery);
        header("Location: " . $_SERVER['PHP_SELF'] . "?show=1&pms_pak_id=".$_REQUEST['pms_pak_id']."&op=2");
    }
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Profile Pictures <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b> Manage Profile Pictures : </b> You can  Manage Profile Pictures  here </p>
        </blockquote>
    </div>
</div>


<!--<img src="files/contents/6956_test1.jpg" style="width:100px;">-->
<?php


//echo "files/contents/6956_test1.jpg:<br />\n";
//$exif = exif_read_data('files/contents/6956_test1.jpg', 'IFD0');
//echo $exif===false ? "No header data found.<br />\n" : "Image contains headers<br />\n";
//
//
//$exif = exif_read_data('files/contents/6956_test1.jpg', 0, true);
//echo "test2.jpg:<br />\n";
    ...
    if (isset($_REQUEST['show']) && $_REQUEST['show'] == 1) {
        ...
        ?>
                    ...
                    <div class="panel-body">
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="example2" >
                                <thead>
                                    <tr>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Guest Name/Group</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Face Image</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Choose File &nbsp; | &nbsp; Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <form name="frm" id="frm" method="post" class="form-horizontal" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>"  enctype="multipart/form-data"  role="form">
                                                        <input type="file" name="photo" style="float:left;"> &nbsp; | &nbsp; 
                                                        <input type="hidden" value="<?php echo $row->cont_image;?>" name="old_img">
                                                        <input type="hidden" value="<?php echo $row->ContactID;?>" name="contactid">
                                                        <input type="submit" name="btnUpdate" class="btn btn-primary btn-animate-demo" value="Update" />
                                                    </form>
                                                </td>
                                            </tr>
                            <?php
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i>  Profile Pictures 
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
