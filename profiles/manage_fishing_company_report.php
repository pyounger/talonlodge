...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Report for Fish Processing Company <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b> Report for Fish Processing Company: </b> You can manage Report for Fish Processing Company here </p>
        </blockquote>
    </div>
</div>
...
//                                                    }
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-list"></i> Report for Fish Processing Company
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
		...
		$Query = "SELECT p.* FROM packages AS p WHERE p.Arrival_Start_Date > '".date("Y-m-d",strtotime(date("Y")."-1-1"))."' ORDER BY p.Arrival_Start_Date ASC";
        $counter = 0;
        $limit = $_SESSION['limit_of_rec'];
        $start = $p->findStart($limit);
        $count = mysql_num_rows(mysql_query($Query));
                ...
                ?>
                                            <tr>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <a href="manage_fishing_company_report_print.php?pms_pak_id=<?php echo $row->Pms_Package_ID;?>" target="_blank">
