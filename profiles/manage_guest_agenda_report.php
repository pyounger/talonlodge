...
if ((isset($_REQUEST['pk_from'])) && ($_REQUEST['pk_from'] != '')) {
    ...
    $_SESSION['pk_from'] = date("Y-m-d",strtotime("-1 week")); //current date.
}
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Guest Agenda Report <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Guest Agenda Report: </b> You can  Manage Guest Agenda Report here </p>
        </blockquote>
    </div>
</div>
...
ORDER BY g.GroupName,  c.ContactFirstName ASC";
                                        ...
                                        if (mysql_num_rows($rs) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg"><a href="<?php echo "manage_guest_agenda_report_print.php?pms_pak_id=".$_REQUEST['pms_pak_id']."&cont_id=".$row->ContactID."&grp_id=".$row->grp_id;?>" target="_blank" >Click for Report</a></td>
                                            </tr>
                            <?php
                        }
                    } else {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i>  Guest Agenda Report 
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
