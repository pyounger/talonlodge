...
if (isset($_REQUEST['btnAdd'])) {
    for($i=0; $i<count($_REQUEST['bitem_id']); $i++){
        if($_REQUEST['bitem_id'][$i]!=0 && $_REQUEST['bitem_id'][$i]!='' && $_REQUEST['bord_quatity'][$i]!=''){
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Bar Tab <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Bar Tab: </b> You can manage your Bar Tab here </p>
        </blockquote>
    </div>
</div>
                            ...
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="" >
                                <thead>
                                    <tr>
                                        ...
                                        <th class="visible-xs visible-sm visible-md visible-lg">Bar Item</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Quantity</th>
...
ORDER BY g.GroupName,  c.ContactFirstName ASC";
                                        ...
                                        if (mysql_num_rows($rs) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="bitem_id[]" id="bitem_id[]" data-placeholder="Choose an Item..." class="chosen-" style="width:240px; z-index: 9999 !important;" tabindex="2">
                                                        <?php echo FillSelected("bar_items WHERE bitem_type=1 ", "bitem_id", "bitem_name", @$bvo_id) ?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <input type="text" class="form-control form-cascade-control input_wid70" placeholder="" value="" name="bord_quatity[]" size="2" maxlength="2">
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <input type="hidden" value="<?php echo $row->ContactID;?>" name="cont_id[]">
                                                    <input type="hidden" value="<?php echo $row->grp_id;?>" name="grp_id[]">
                                                    <input type="hidden" value="<?php echo $_REQUEST['pms_pak_id'];?>" name="pms_pak_id">
                                                    <input type="hidden" value="<?php echo $row->Pms_Package_ID;?>" name="pms_pak_id1[]">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Bar Tab
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
