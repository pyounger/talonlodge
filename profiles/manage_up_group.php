...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Upcoming Groups <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b>Manage Upcoming Groups: </b> You can manage upcoming groups or trips information here </p>
        </blockquote>
    </div>
</div>
