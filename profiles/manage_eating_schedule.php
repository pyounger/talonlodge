...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Manage Menu/Beverage Order Schedule <i class="fa fa-info-circle animated bounceInDown show-info"></i></h3>
        <blockquote class="page-information hidden">
            <p> <b> Manage Menu/Beverage Order Schedule : </b> You can  Manage Menu/Beverage Order Schedule  here </p>
        </blockquote>
    </div>
</div>
                    ...
                    <div class="panel-body">
                        <form name="frm" id="frm" method="post" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>" class="form-horizontal" role="form">
                            <table class="table users-table table-condensed table-hover table-striped display dataTable" id="" >
                                <thead>
                                    <tr>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Guest Name<br/>Group</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Guest Picture</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Food Allergies</th>
                                        <?php
                                            $day_counter = 0;
                                            $day_counter1 = 0;
                                            $date1 = '';
...
p.Pms_Package_ID, p.Package_Name, p.Arrival_Start_Date, p.Arrival_End_Date, p.Package_Max_Days,
g.grp_id, g.GroupName,
gc.ContactID, c.ContactFirstName, c.ContactLastName, c.cont_image, c.cont_special_ins,
cp.conp_id, cp.bootsize_id,
j.jacketsize_name,
b.bootsize_name
FROM packages AS p 
...
p.Pms_Package_ID = " . $_REQUEST['pms_pak_id'] . "  
AND p.Arrival_Start_Date > '2014-05-01'  
AND g.GroupArrivalDate > '2014-05-01' AND c.is_completed>=1

GROUP BY
p.Pms_Package_ID, p.Package_Name, p.Arrival_Start_Date, p.Arrival_End_Date, 
p.Package_Max_Days, g.grp_id, g.GroupName, gc.ContactID, c.ContactFirstName, 
c.ContactLastName, c.cont_image, c.cont_special_ins, cp.conp_id, cp.bootsize_id, 
j.jacketsize_name, b.bootsize_name
...
//print($Query);
                                        ...
                                        if (mysql_num_rows($rs) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-xs visible-sm visible-md visible-lg"><img src="files/contents/<?php echo $row->cont_image;?>" style="max-width: 250px;" /> </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg" style="max-width: 150px;">
                                                    <?php
                                                        $Query33 = "SELECT
                                                ...
                                                <?php
                                                    ...
                                                    $period = new DatePeriod($begin, $interval, $end);
                                                    $no_of_days = diffindates($date1, $date2);
                                                    $total_package_days = ($no_of_days - 2);
                                                    ...
                                                    foreach ($period as $dt):
                                                        ...
                                                        if ($no_of_days != $day_counter) {
                                                            ...
                                                            if ($day_counter != 1) {
                                                                if ($no_of_days == $day_counter) {
                                                                    //echo '<br/>2.1 No Activity<br/>';
                                                                } else {
                                                                    if ($no_of_days != (1+ $day_counter)) {
                                                                        echo '<td class="visible-xs visible-sm visible-md visible-lg">';
                                                                        $day_counter1++;
                                                                        //echo '<br/><br/>'.$dt->format("Y-m-d").'<br/><br/>';
                                                                        $Query33 = "SELECT msch.* FROM menu_schedules AS msch WHERE msch.cont_id = ".$row->ContactID." AND msch.grp_id = ".$row->grp_id."  AND msch.pms_pak_id = ".$row->Pms_Package_ID." AND msch.msch_date = '".$dt->format("Y-m-d")."' GROUP BY msch.msch_date ";
                                                                        //echo '<br/><br/><br/>';
                                                                        @$count33 = mysql_num_rows(mysql_query($Query33));
                                                                        $rs33 = mysql_query($Query33);
                                                                        if ($count33 > 0) {
                                                                            while ($row33 = mysql_fetch_object($rs33)) {
                                                                                ...
                                                                                @$counter44 = 0;
                                                                                $mb = $ml = $md = 0;
                                                                                $Query44 = "SELECT msch.* FROM menu_schedules AS msch WHERE msch.cont_id = ".$row33->cont_id." AND msch.grp_id = ".$row33->grp_id."  AND msch.pms_pak_id = ".$row33->pms_pak_id." AND msch.msch_date = '".$row33->msch_date."' ";
                                                                                //echo '<br/><br/><br/>';
                                                                                @$count44 = mysql_num_rows(mysql_query($Query44));
                                                                                $rs44 = mysql_query($Query44);
                                                                                if ($count44 > 0) {
                                                                                    while ($row44 = mysql_fetch_object($rs44)) {
                                                                                        @$counter44++;
                                                                                        if($row44->menu_b!='' && $row44->msch_type==1){
                                                                                            $mb = 1;
//                                                                                            echo 'Breakfast<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a><br/>';
                                                                                            echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".($day_counter1-1)."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        } else if($row44->menu_l!='' && $row44->msch_type==2){
                                                                                            $ml = 1;
//                                                                                            echo 'Lunch<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a><br/>';
                                                                                            echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".($day_counter1-1)."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        } else if($row44->menu_d!='' && $row44->msch_type==3){
                                                                                            $md = 1;
//                                                                                            echo 'Dinner<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
                                                                                            echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".($day_counter1-1)."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        }
                                                                                        //echo '<br/>BLD: '.@$count44.' '.$counter44;
                                                                                        if($count44 == $counter44){
                                                                                            if($count44<3){
                                                                                                //echo '<br/>cnt: '.$count44.' cntr: '.$counter44.' b: '.$mb.' l: '.$ml.' d: '.$md;
                                                                                                if($mb==0){
                                                                                                    echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".($day_counter1-1)."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
                                                                                                }
                                                                                                if($ml==0){
                                                                                                    echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".($day_counter1-1)."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
                                                                                                }
                                                                                                if($md==0){
                                                                                                    echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".($day_counter1-1)."&add=1&type=3&pkg=".($total_package_days)."".'>Add</a>';
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
                                                                            ...
                                                                            echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".($day_counter1-1)."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
                                                                            echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".($day_counter1-1)."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
                                                                            echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".($day_counter1-1)."&add=1&type=3&pkg=".($total_package_days)."".'>Add</a>';
                                                                        }
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            WHERE msc.cont_id = ".$row->ContactID." AND msc.msch_date = '".$dt->format("Y-m-d")."' 
                                                                            ORDER BY msc.msch_date, msc.msch_type ASC ");
                                                                            if(mysql_num_rows($rsM)>0){
                                                                                while($rsMem = mysql_fetch_object($rsM)){
                                                                                    if($rsMem->msch_type==1){
                                                                                        if(!empty($rsMem->mib) || !empty($rsMem->mibd) || !empty($rsMem->msch_custom_order)){
                                                                                            echo '<br/>Breakfast';
                                                                                            echo (!empty($rsMem->mib)?'<br/>Regular: '.$rsMem->mib:'');
                                                                                    ...
                                                                                    if($rsMem->msch_type==2){
                                                                                        if(!empty($rsMem->mil) || !empty($rsMem->mild) || !empty($rsMem->msch_custom_order)){
                                                                                            echo '<br/><br/>Lunch';
                                                                                            echo (!empty($rsMem->mil)?'<br/>Regular: '.$rsMem->mil:'');
                                                                                            echo (!empty($rsMem->mild)?'<br/>Custom: '.$rsMem->mild:'');
                                                                                            echo (!empty($rsMem->msch_custom_order)?'<br/>Extended Custom: '.$rsMem->msch_custom_order:'');
                                                                                        }
                                                                                    }
                                                                                    if($rsMem->msch_type==3){
                                                                                        if(!empty($rsMem->mid) || !empty($rsMem->midd) || !empty($rsMem->msch_custom_order)){
                                                                                            echo '<br/><br/>Dinner';
                                                                                            echo (!empty($rsMem->mid)?'<br/>Regular: '.$rsMem->mid:'');
                                                                                            echo (!empty($rsMem->midd)?'<br/>Custom: '.$rsMem->midd:'');
                                                                                            echo (!empty($rsMem->msch_custom_order)?'<br/>Extended Custom: '.$rsMem->msch_custom_order:'');
                                                                                        }
                                                                                    }
                                                                                }    
                                                                            ...
                                                                            WHERE 
                                                                            bo.cont_id = ".$row->ContactID." AND bo.bvo_date = '".$dt->format("Y-m-d")."' ");
                                                                            $total1 = mysql_num_rows($rsM);
                                                                            if ($total1 > 0) {
                                                                            echo '<br/><br/>Beverage Order:<br/>';
...
//                                                                        echo $day_counter1.'<br/>2.3 No Activity<br/>';
//                                                                        $Query33 = "SELECT msch.* FROM menu_schedules AS msch WHERE msch.cont_id = ".$row->ContactID." AND msch.grp_id = ".$row->grp_id."  AND msch.pms_pak_id = ".$row->Pms_Package_ID." AND msch.msch_date = '".$dt->format("Y-m-d")."' GROUP BY msch.msch_date ";
//                                                                        //echo '<br/><br/><br/>';
//                                                                        @$count33 = mysql_num_rows(mysql_query($Query33));
//                                                                        $rs33 = mysql_query($Query33);
...
//                                                                                            $mb = 1;
////                                                                                            echo 'Breakfast<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a><br/>';
//                                                                                            echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a><br/>';
//                                                                                        } else if($row44->menu_l!='' && $row44->msch_type==2){
//                                                                                            $ml = 1;
////                                                                                            echo 'Lunch<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a><br/>';
//                                                                                            echo 'Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a><br/>';
//                                                                                        } else if($row44->menu_d!='' && $row44->msch_type==3){
//                                                                                            $md = 1;
////                                                                                            echo 'Dinner<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days+1)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
//                                                                                            echo 'Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
//                                                                                        }
//                                                                                        //echo '<br/>BLD: '.@$count44.' '.$counter44;
//                                                                                        if($count44 == $counter44){
//                                                                                            if($count44<3){
//                                                                                                //echo '<br/>cnt: '.$count44.' cntr: '.$counter44.' b: '.$mb.' l: '.$ml.' d: '.$md;
//                                                                                                if($mb==0){
//                                                                                                    echo '<br/>Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
//                                                                                                }
//                                                                                                if($ml==0){
//                                                                                                    echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
//                                                                                                }
//                                                                                                if($md==0){
//                                                                                                    echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Add</a>';
//                                                                                                }
//                                                                                            }
//                                                                                        }
//                                                                                    }
...
//                                                                            }
//                                                                        } else {
//                                                                            echo '<br/>Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
//                                                                            echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
//                                                                            echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Add</a>';
//                                                                        }
                                                                        
//                                                                        $Query33 = "SELECT msch.* FROM menu_schedules AS msch WHERE msch.cont_id = ".$row->ContactID." AND msch.grp_id = ".$row->grp_id."  AND msch.pms_pak_id = ".$row->Pms_Package_ID." AND msch.msch_date = '".$dt->format("Y-m-d")."'";
//                                                                        @$count33 = mysql_num_rows(mysql_query($Query33));
//                                                                        $rs33 = mysql_query($Query33);
//                                                                        if ($count33 > 0) {
//                                                                            while ($row33 = mysql_fetch_object($rs33)) {
//                                                                                echo 'Already Set <br/> <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&add=1".'>Details</a>';
//                                                                            }
//                                                                        } else {
//                                                                            echo '<a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&add=1".'>Not Set</a>';
//                                                                        }
                                                                    }
                                                                }
                                                            } else {
                                                                //echo '<br/>3.1 No Activity<br/>';
//                                                                $Query33 = "SELECT msch.* FROM menu_schedules AS msch WHERE msch.cont_id = ".$row->ContactID." AND msch.grp_id = ".$row->grp_id."  AND msch.pms_pak_id = ".$row->Pms_Package_ID." AND msch.msch_date = '".$dt->format("Y-m-d")."'";
//                                                                @$count33 = mysql_num_rows(mysql_query($Query33));
//                                                                $rs33 = mysql_query($Query33);
//                                                                if ($count33 > 0) {
                                                                                ...
                                                                                if ($count44 > 0) {
                                                                                    while ($row44 = mysql_fetch_object($rs44)) {
                                                                                        ...
                                                                                        if($row44->menu_b!='' && $row44->msch_type==1){
                                                                                            $mb = 1;
//                                                                                            echo 'Breakfast<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a><br/>';
                                                                                            echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        } else if($row44->menu_l!='' && $row44->msch_type==2){
                                                                                            $ml = 1;
//                                                                                            echo 'Lunch<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a><br/>';
                                                                                            echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        } else if($row44->menu_d!='' && $row44->msch_type==3){
                                                                                            $md = 1;
//                                                                                            echo 'Dinner<br/><a href=' . $_SERVER['PHP_SELF'] . "?show=3&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Details</a> - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
                                                                                            echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row44->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Update</a>';
                                                                                        }
                                                                                        //echo '<br/>BLD: '.@$count44.' '.$counter44;
                                                                                        if($count44 == $counter44){
                                                                                            if($count44<3){
                                                                                                //echo '<br/>cnt: '.$count44.' cntr: '.$counter44.' b: '.$mb.' l: '.$ml.' d: '.$md;
                                                                                                if($mb==0){
                                                                                                    echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
                                                                                                }
                                                                                                if($ml==0){
                                                                                                    echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
                                                                                                }
                                                                            ...
                                                                            echo 'Breakfast - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=1&pkg=".($total_package_days)."".'>Add</a>';
                                                                            echo '<br/>Lunch - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=2&pkg=".($total_package_days)."".'>Add</a>';
                                                                            echo '<br/>Dinner - <a href=' . $_SERVER['PHP_SELF'] . "?show=2&pms_pak_id=" . @$row->Pms_Package_ID . "&grp_id=" . @$row->grp_id."&contactid=" . @$row->ContactID . "&date=".@$dt->format("Y-m-d")."&msch_id=".@$row33->msch_id."&day=".$day_counter1."&add=1&type=3&pkg=".($total_package_days)."".'>Add</a>';
                                                                        }
...
WHERE msc.msch_id = ".$_REQUEST['msch_id']);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i>  Menu/Beverage Order Schedule 
                            <span class="pull-right" style="width:auto;">
                            </span> 
                        </h3>
                    </div>
...
<!--                                        <th class="visible-xs visible-sm visible-md visible-lg">Default Breakfast</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Default Lunch</th>
                                        <th class="visible-xs visible-sm visible-md visible-lg">Default Dinner</th>
        ...
        FROM packages AS p 
        LEFT OUTER JOIN menu_default_pkg AS mpd ON p.Pms_Package_ID = mpd.pms_pak_id AND mpd.cont_id=0 
        WHERE p.Arrival_Start_Date > '2014-05-01'  
        ...
        ORDER BY YEAR(p.Arrival_Start_Date) DESC, p.Arrival_Start_Date ASC ";
        $counter = 0;
        $limit = $_SESSION['limit_of_rec'];
        $start = $p->findStart($limit);
        $count = mysql_num_rows(mysql_query($Query));
...
<!--                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_b" style="width: 110px;" >
                                                        <option value="0">Select</option>
                                                        <?php echo FillSelected("menus WHERE menu_type=1 ", "menu_id", "menu_item_name", @$row->menu_b);?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_l" style="width: 110px;" >
                                                        <option value="0">Select</option>
                                                        <?php echo FillSelected("menus WHERE menu_type=2 ", "menu_id", "menu_item_name", @$row->menu_l);?>
                                                    </select>
                                                </td>
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <select name="menu_id_d" style="width: 110px;" >
                                                        <option value="0">Select</option>
                                                        <?php echo FillSelected("menus WHERE menu_type=3 ", "menu_id", "menu_item_name", @$row->menu_d);?>
                                                    </select>
                                                </td>
                                                
                                                <td class="visible-xs visible-sm visible-md visible-lg">
                                                    <input type="hidden" name="md_pkg_id" value="<?php echo  @$row->md_pkg_id;?>" >
                                                    <input type="hidden" name="pms_pak_id" value="<?php echo @$row->Pms_Package_ID;?>" >
                                                    <input type="submit" value="Set" name="addMenuRec" class="btn bg-primary text-white">
                                                </td>-->
<!--                                                </form>-->
                                            </tr>
                <?php
