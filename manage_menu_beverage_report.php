    ...
    <div class="row">
        ...
        <ul class="nav faq-list">
            ...
            <?php
                ...
                (SELECT COUNT(msc.menu_b) FROM menu_schedules AS msc WHERE ms.menu_b = msc.menu_b ) AS total_menu,
                me.menu_item_name
            ...
            <?php
                ...
                (SELECT COUNT(msc.menu_l) FROM menu_schedules AS msc WHERE ms.menu_l = msc.menu_l ) AS total_menu,
                me.menu_item_name
            ...
            <?php
                ...
                (SELECT COUNT(msc.menu_d) FROM menu_schedules AS msc WHERE ms.menu_d = msc.menu_d ) AS total_menu,
                me.menu_item_name
            ...
            <table width="100%">
                <thead>
                    <tr>
                        <th> Guest Name </th>
                        <th> Allergy/Special Instructions </th>
                        <th> Breakfast </th>
                        <th> Lunch </th>
                        <th> Dinner </th>
                        <th> Beverage Order </th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td style=" vertical-align: top; color: #ff3333;"> &nbsp;<br/> 
                            <?php
                                $counter5=0;
                                $Query5 = "
