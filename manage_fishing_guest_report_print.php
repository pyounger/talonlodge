            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading text-primary">
                        <h3 class="panel-title"><i class="fa fa-glass"></i> Fishing Report for Guest - 
                                <?php
                                    $Query = "SELECT
                    ...
                    echo '<table class="table users-table table-condensed table-hover table-striped display dataTable" >';
                        echo '<tr>';
                            echo '<th style="vertical-align:top; text-align: left;" >';
                                echo '<div style="padding-left:50px; text-align: left;">'.$row99->Package_Name.', '.calendarDateConver2($row99->Arrival_Start_Date).', '.calendarDateConver2($row99->Arrival_End_Date).'</div>';
                            echo '</th>';
                        echo '</tr>';
                    echo '</table>';
                                        ...
                                        echo '<table class="table users-table table-condensed table-hover table-striped display dataTable" style="vertical-align:top; text-align: left;" >';
                ?>
                                                    <?php
                                                        $Query88 = " 
                                                        SELECT
                                                        ...
                                                        WHERE p.Pms_Package_ID = ".$row99->Pms_Package_ID." AND p.Arrival_Start_Date > '2014-05-01' AND g.grp_id=c.grp_id AND g.grp_id = ".$_REQUEST['grp_id']."
                                                        GROUP BY g.grp_id 
                                                        ...
                                                        if ($count88 > 0) {
                                                            while ($row88 = mysql_fetch_object($rs88)) {
                                                                echo '<tr>';
                                                                    //echo '<th style="vertical-align:top; text-align: left;" >';
                                                                        echo '<td style="vertical-align:top; padding-left:100px; padding-top:10px; text-align: left;" class="visible-xs visible-sm visible-md visible-lg">';
                    ...
                    <div class="col-mol-md-offset-2">
                        <form class="form-horizontal cascde-forms" method="post" action="<?php print($_SERVER['PHP_SELF']); ?>" name="frm" id="frm" >
                                <div style="padding-left: 50px;">
                                    <table style="text-align: left;" cellpadding="8">
                                        <thead>
                                            <tr>
                                                                                        ...
                                                                                        echo '<th class="visible-xs visible-sm visible-md visible-lg" style="vertical-align:top; text-align: left;" >';
                                                                                            echo " 
                                                                                                <table style='text-align: left;'>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <th width='250' style='vertical-align:top; text-align: left;' >
                                                                                                            <br/><br/> &nbsp; ";
...
<div style="padding-left:58px; padding-top: 20px; padding-bottom: 20px; text-align: left;" >
    <table style="text-align: left;" cellpadding="8">
        <tr>
            <th>
                Guest
        ...
        <?php
            ...
            AND fr.pms_pak_id = ".$row99->Pms_Package_ID." 
            AND fr.cont_id != '' AND fr.cont_id = ".$_REQUEST['cont_id']." ";
