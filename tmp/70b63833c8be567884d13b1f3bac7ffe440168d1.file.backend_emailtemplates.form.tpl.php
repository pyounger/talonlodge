<?php /* Smarty version Smarty-3.0.8, created on 2016-12-08 06:51:48
         compiled from "/home2/talonlod/public_html/app/templates/forms/backend_emailtemplates.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:953713701584981949dae49-94403424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70b63833c8be567884d13b1f3bac7ffe440168d1' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/forms/backend_emailtemplates.form.tpl',
      1 => 1475595700,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '953713701584981949dae49-94403424',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.email_templates.editing_template<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }else{ ?>
		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.email_templates.adding_template<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.email_templates.email_templates'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
...
$_template->properties['nocache_hash']  = '953713701584981949dae49-94403424';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
	...
	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"text",'field'=>"subject",'class'=>"span9"));?>

    <?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"ck_editor",'field'=>"body",'class'=>"extended",'loadJS'=>"true",'height'=>600));?>


    
                
<div class="form-actions">
    <?php smarty_template_function_cpf_button($_smarty_tpl,array('title'=>t('backend.common.preview'),'class'=>'btn-success','icon'=>'zoom-in icon-white','url'=>cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'view','id'=>$_smarty_tpl->getVariable('id')->value)),'target'=>"_blank"));?>
