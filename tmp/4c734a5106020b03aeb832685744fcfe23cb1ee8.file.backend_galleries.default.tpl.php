<?php /* Smarty version Smarty-3.0.8, created on 2016-10-11 07:55:06
         compiled from "/home2/talonlod/public_html/app/templates/backend_galleries.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11531151557fd0b5ac63a78-13892431%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c734a5106020b03aeb832685744fcfe23cb1ee8' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/backend_galleries.default.tpl',
      1 => 1475595433,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11531151557fd0b5ac63a78-13892431',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.galleries.galleries<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array($_tmp1,'')), null, null);?>
    ...
    <?php if (false&&count($_smarty_tpl->getVariable('types')->value)>0){?>
    <ul class="nav nav-pills">
        <?php  $_smarty_tpl->tpl_vars['_type'] = new Smarty_Variable;
...
?>
        <li<?php if (!$_smarty_tpl->getVariable('type')->value||$_smarty_tpl->getVariable('type')->value==$_smarty_tpl->tpl_vars['_type']->value['id']){?> class="active"<?php }?>><a href="#"><?php echo $_smarty_tpl->tpl_vars['_type']->value['title'];?>
</a></li>
        <?php }} ?>
    </ul>
    <?php }?>
...
$_template->assign('actions',Smarty::$_smarty_vars['capture']['common_actions']);$_template->properties['nocache_hash']  = '11531151557fd0b5ac63a78-13892431';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.8, created on 2016-10-11 07:55:07
...
" class="table table-striped">
    ...
    <?php if (count($_smarty_tpl->getVariable('cpf_entities')->value)>1){?>
        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'id','title'=>t('tables.galleries.id')));?>

        <?php smarty_template_function_cpf_th($_smarty_tpl,array('field'=>'title','title'=>t('tables.galleries.title')));?>
...
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
                ...
                <?php }?>
                <span class="label label-info"><?php echo $_smarty_tpl->getVariable('item')->value->gallerytype->title;?>
</span>
            </td>
            <?php if ($_smarty_tpl->getVariable('show_actions')->value){?>
                <td>
                    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->has_rights($_smarty_tpl->getVariable('cpf_controller')->value,'view')){?>
                        <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value,'action'=>'view','id'=>$_smarty_tpl->getVariable('item')->value->id),$_smarty_tpl);?>
"><i class="icon-th"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
