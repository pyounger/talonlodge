<?php /* Smarty version Smarty-3.0.8, created on 2016-10-05 06:49:24
         compiled from "/home2/talonlod/public_html/app/templates/backend_profile.login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:104380946857f512f4bb1047-76842302%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dda8a351eea4700e10998b691b843a8b56473f56' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/backend_profile.login.tpl',
      1 => 1475595448,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '104380946857f512f4bb1047-76842302',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
<head>
	<title>
		<?php ob_start(); ?>
	<?php ob_start(); ?>Authorization<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php ob_start(); ?>
		...
		messages:
		{
			login: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Please, check login<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
			password: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Please, check password<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
		}
...
" method="post" id="cpf-page-form" class="well">
        <h3><?php echo Smarty::$_smarty_vars['capture']['page_title'];?>
</h3>
        <br />
...
$_template->properties['nocache_hash']  = '104380946857f512f4bb1047-76842302';
...
<?php $_smarty_tpl = array_pop($_tpl_stack);?><?php unset($_template);?>
        <?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'text','label'=>t('Login'),'field'=>'login','value'=>$_smarty_tpl->getVariable('login')->value,'class'=>'field_login'));?>

        <?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'password','label'=>t('Password'),'field'=>"password",'value'=>$_smarty_tpl->getVariable('password')->value,'class'=>"field_login"));?>

        <?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'checkbox','label'=>t('Remember me'),'field'=>"remember",'value'=>$_smarty_tpl->getVariable('remember')->value,'no_border'=>true));?>

        <br />
        <button class="btn btn-primary" type="submit">Login</button>
        <a href="<?php echo $_smarty_tpl->getVariable('cpf_root_url')->value;?>
" class="btn">Back to the website</a>
    </form>
