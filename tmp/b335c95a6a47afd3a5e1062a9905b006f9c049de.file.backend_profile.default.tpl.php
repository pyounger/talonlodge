<?php /* Smarty version Smarty-3.0.8, created on 2017-10-13 10:27:44
         compiled from "/home2/talonlod/public_html/app/templates/backend_profile.default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14756850559e105a095f721-35340682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b335c95a6a47afd3a5e1062a9905b006f9c049de' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/backend_profile.default.tpl',
      1 => 1475595447,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14756850559e105a095f721-35340682',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
Профиль<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('Профиль'),'')), null, null);?>

	<?php ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['link'][0][0]->link(array('controller'=>'backend_index'),$_smarty_tpl);?>
...
$_template->properties['nocache_hash']  = '14756850559e105a095f721-35340682';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
	...
	<p><b><?php echo $_smarty_tpl->getVariable('cpf_current_entity')->value->login;?>
</b></p>
	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'text','field'=>'name'));?>

	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'text','field'=>'surname'));?>

    <br />
	<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>'password','field'=>'password','no_value'=>'true'));?>

	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'password','field'=>'password_c','value'=>'','label'=>t('Password confirmation')));?>

	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'comment','value'=>t('Enter your current password for submitting changes')));?>

	<?php smarty_template_function_cpf_input($_smarty_tpl,array('type'=>'password','field'=>'password_current','label'=>t('Current password')));?>
...
backend.common.crisp_studio<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
	...
	<?php ob_start(); ?>
		...
		messages:
		{
			name: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Please, check user\'s name<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
			password_c: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Passwords do not match<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
			password_current: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Current password is empty<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
		}
