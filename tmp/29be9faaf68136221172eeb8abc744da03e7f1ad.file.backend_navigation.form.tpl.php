<?php /* Smarty version Smarty-3.0.8, created on 2015-12-02 14:53:04
         compiled from "/home2/talonlod/public_html/app/templates/forms/backend_navigation.form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:912435410565f84609ae3a1-75954973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29be9faaf68136221172eeb8abc744da03e7f1ad' => 
    array (
      0 => '/home2/talonlod/public_html/app/templates/forms/backend_navigation.form.tpl',
      1 => 1333505564,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '912435410565f84609ae3a1-75954973',
  'function' => 
  array (
    'cpf_submit' => 
    array (
...
backend.navigation.editing_menu<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }else{ ?>
		<?php ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
backend.navigation.adding_menu<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['t'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php  Smarty::$_smarty_vars['capture']['page_title']=ob_get_clean();?>
	<?php }?>
...
<?php }?>"><?php echo $_smarty_tpl->getVariable('cpf_site_title')->value;?>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<?php $_smarty_tpl->tpl_vars['cpf_breadcrumb'] = new Smarty_variable(array(array(t('backend.navigation.menu'),cpf_link(array('controller'=>$_smarty_tpl->getVariable('cpf_controller')->value))),array(Smarty::$_smarty_vars['capture']['page_title'])), null, null);?>
...
$_template->properties['nocache_hash']  = '912435410565f84609ae3a1-75954973';
...
" method="post" id="cpf-page-form"<?php if (Smarty::$_smarty_vars['capture']['is_upload_form']){?> enctype="multipart/form-data"<?php }?> class="form-horizontal">
    ...
    <?php if ($_smarty_tpl->getVariable('cpf_rights')->value->is_root()){?>
		<?php smarty_template_function_cpf_input_helper($_smarty_tpl,array('type'=>"slug",'field'=>"key",'title_field'=>'title'));?>
